...
<style>
	...
	uni-page-body .fixed .last uni-input{
		height: 29px !important;
		padding: 0 0 0 5px;
	}
	uni-page-body .list .card .bottom .box{
		padding: 5px !important;
	}
	uni-page-body .list .card .bottom .box .content .uni-combox{
		height: 30px !important;
	}
	uni-page-body .list .card .btns{
