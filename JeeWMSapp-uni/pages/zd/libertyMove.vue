	...
	<view class="content">
		...
		<view class="Search">
			...
			<view class="saoma_father1" >
				<input class="input_first" type="text" :focus="isFocus1" v-model="query01"  @confirm="getDetails(1)" :placeholder="$t('请扫描储位')" />
				<image @click="scanClick('query01')" src="../../static/ZX/sm.png" class="saoma" ></image>
			</view>
			<view class="saoma_father2" >
				<input class="input_second" type="text" :focus="isFocus1" v-model="query02"  @confirm="getDetails(1)" :placeholder="$t('请扫描托盘')" style="margin-top:10rpx;"/>
