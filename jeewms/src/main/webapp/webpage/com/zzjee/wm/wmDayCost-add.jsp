...
<head>
 ...
 <body>
	...
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wmDayCostController.do?doAdd" tiptype="1" >
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								...
								dictTable="mv_cus" dictField="cus_code" dictText="cus_name" hasLabel="false"  title="客户"></t:dictSelect>     
			          ...
			          <div class="col-xs-3">
								...
								dictTable="ba_cost" dictField="cost_code" dictText="cost_name" hasLabel="false"  title="费用"></t:dictSelect>     
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
