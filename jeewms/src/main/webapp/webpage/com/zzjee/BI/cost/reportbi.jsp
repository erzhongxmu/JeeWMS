...
<script type="text/javascript">
	...
	<script>
        setInterval(function(){
            ...
            var x="欢迎您使用WMS费用主题看板，现在时间："+myDate.getFullYear()+"年"+month+"月"+myDate.getDate()+"日 "+myDate.getHours()+"点"+myDate.getMinutes()+"分"+myDate.getSeconds()+"秒";
		...
		<div class="col-lg-3 col-sm-3 col-xs-12 info-panel">
			<div class="widget widget-shadow">
				<div class="widget-content bg-white padding-20">
					...
					<span class="margin-left-15 font-weight-400">总费用</span>
					<div class="content-text text-center margin-bottom-0">
						...
						<p class="blue-grey-400 font-weight-100 margin-0">总费用</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-lg-3 col-sm-3 col-xs-12 info-panel">
			<div class="widget widget-shadow">
				<div class="widget-content bg-white padding-20">
					...
					<span class="margin-left-15 font-weight-400">当期总费用</span>
					<div class="content-text text-center margin-bottom-0">
						<i class="text-danger icon wb-triangle-up font-size-20"> </i>
						<span class="font-size-30 font-weight-100">${num3}</span>
						<p class="blue-grey-400 font-weight-100 margin-0">当期总费用</p>
					</div>
				</div>
			</div>
		</div>
		<div class="col-lg-3 col-sm-3 col-xs-12 info-panel">
			<div class="widget widget-shadow">
				<div class="widget-content bg-white padding-20">
					...
					<span class="margin-left-15 font-weight-400">当期仓租</span>
					<div class="content-text text-center margin-bottom-0">
						<i class="text-danger icon wb-triangle-up font-size-20"> </i>
						<span class="font-size-30 font-weight-100">${num4}</span>
						<p class="blue-grey-400 font-weight-100 margin-0">当期仓租</p>
					</div>
				</div>
			</div>
		</div>
