...
export function numAdd(num1, num2) {
  ...
  if(num1 == 18492.6){
    console.log((num1 * baseNum + num2 * baseNum) / baseNum,num1 , baseNum, num2, baseNum, baseNum);
  }
...
export function numMulti(num1, num2) {
  ...
  console.log(num1,num2,Math.pow(10, baseNum));
...
export function accDiv(arg1, arg2) {
  ...
  var t1 = 0,
      ...
      r1, r2;
  try {
      t1 = arg1.toString().split(".")[1].length //2
  } catch (e) {}
  try {
      t2 = arg2.toString().split(".")[1].length // 2
  } catch (e) {}
      ...
      console.log(r1,r2,(r1 / r2),Math.pow(10, t2 - t1),t2 - t1)
...
export  function OUT_PUT(n) {
  return n.toString().replace(/\d+/, function (m) {
...
export  function OUT_PUT2(n) {
  return n.toString().replace(/\d+/, function (m) {
      return m.replace(/(\d)(?=(\d{2})+$)/g, function (y) {
          return y + ","
      })
  })
}
