...
const app = {
  ...
  mutations: {
    SET_SYSTEM_PATTERN(state, systemPattern) {
      state.systemPattern = systemPattern;
    },
  ...
  actions: {
    setSystemPattern: ({ commit }, type) => {
      commit('SET_SYSTEM_PATTERN', type)
    },
    setLanguage: ({ commit }, type) => {
      commit('SET_LANGUAGE', type)
    },
