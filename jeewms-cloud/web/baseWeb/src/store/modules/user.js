        ...
        queryPermissionsByUser().then(response => {
          ...
          if (menuData && menuData.length > 0) {
            ...
            menuData.forEach((item, index) => {
              // item.meta.title = item.meta.componentName
              if (item["children"]) {
                let hasChildrenMenu = item["children"].filter((i) => {
                  // i.meta.title = i.meta.componentName
            ...
            //   return {
            //       ...org,
            //       meta:{...org.meta, title:org.meta.componentName},
            //       children:haveChildren ? org.children.map(i => mapTree(i)) : [],
            //   }
            // };
            // let gxqTree = menuData.map(org => mapTree(org) )
            // console.log(" menu show json ", menuData,gxqTree)
