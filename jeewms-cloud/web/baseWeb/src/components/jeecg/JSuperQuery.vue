  ...
  >
    ...
    <template slot="footer">
      <div style="float: left">
        <a-button :loading="loading" @click="handleReset">{{$t('重置')}}</a-button>
        <a-button :loading="loading" @click="handleSave">保存查询条件</a-button>
      </div>
      <a-button :loading="loading" @click="handleCancel">关闭</a-button>
      <a-button :loading="loading" type="primary" @click="handleOk">{{$t('查询')}}</a-button>
    </template>
    ...
    <j-modal title="请输入保存的名称" :visible="prompt.visible" @cancel="prompt.visible=false" @ok="handlePromptOk">
