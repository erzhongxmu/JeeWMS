    ...
    <a-upload
      ...
      <div :style="{'width':(!isMultiple?'104px':'auto'),'height':(!isMultiple?'104px':'auto')}">
        ...
        <div v-else class="iconp">
          ...
          <div class="ant-upload-text">{{ text || $t('上传') }}</div>
        </div>
      </div>
      <j-modal :visible="previewVisible" :footer="null" @cancel="handleCancel()">
...
<style scoped>
  ...
  * https://github.com/zhangdaiscott/base-boot/issues/1810
  * https://github.com/zhangdaiscott/base-boot/issues/1779
  */
