<template>
  <global-layout @dynamicRouterShow="dynamicRouterShow">
    ...
    <a-tabs
      ...
      v-if="multipage && $store.state.app.systemPattern === 'WMS'"
    ...
    >
      ...
      >
        <span slot="tab" :pagekey="page.fullPath">{{ $t(page.meta.title)}}</span>
      </a-tab-pane>
    </a-tabs>

    <!--  -->
    <!--   -->
    <a-breadcrumb :routes="pageList" v-else @contextmenu.native="e => onContextmenu(e)">
      <template slot="itemRender" slot-scope="{ route, params, routes, paths}" >
        <span 
          :pagekey="route.fullPath"
          :class="[route.fullPath == activePage?'breadcrumb_span_a':'','breadcrumb_span']"
          @click="fullPathClick(route.fullPath,paths)">
            {{$t(route.meta.title)}}
        </span>
      </template>
    </a-breadcrumb>
...
export default {
  ...
  methods: {
    fullPathClick(e){
      if(e != this.$router.history.current.fullPath){
        this.activePage = e
