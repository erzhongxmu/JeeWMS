  ...
  export default {
    ...
    data() {
      return {
        ...
        columns: [
          { title: '姓名', align: 'left', width: '25%', widthRight: '70%', dataIndex: 'realname' },
          { title: '账号', align: 'left', width: '25%', dataIndex: 'username' },
          { title: '电话', align: 'left', width: '20%', dataIndex: 'phone' },
          { title: '出生日期', align: 'left', width: '20%', dataIndex: 'birthday' }
        ],
