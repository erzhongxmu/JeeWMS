    ...
    data() {
      return {
        settings: {
          ...
          queryParamText: '职务名称',
          columns: [
            { title: '职务名称', dataIndex: 'name', align: 'left', width: '30%', widthRight: '70%' },
            { title: '职务编码', dataIndex: 'code', align: 'left', width: '35%' },
            { title: '职级', dataIndex: 'rank_dictText', align: 'left', width: '25%' }
          ]
        }
      }
    },
