<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="角色编号">
              <a-input placeholder="请输入角色编号" v-model="queryParam.approleCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
          ...
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="app模块编号">
                <j-popup placeholder="请选择app模块编号" v-model="queryParam.appmodelCode" code="app_function" org-fields="id,appmodel_code,appmodel_name" dest-fields="appmodel_id,appmodel_code,appmodel_name" :field="getPopupField('appmodel_id,appmodel_code,appmodel_name')"/>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('主数据—APP角色')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <wms-app-role-modal ref="modalForm" @ok="modalFormOk"></wms-app-role-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmsAppRoleModal from './modules/WmsAppRoleModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/wmsapp/wmsAppRole/list",
          delete: "/wmsapp/wmsAppRole/delete",
          deleteBatch: "/wmsapp/wmsAppRole/deleteBatch",
          exportXlsUrl: "/wmsapp/wmsAppRole/exportXls",
          importExcelUrl: "/wmsapp/wmsAppRole/importExcel",
        },
        dictOptions:{},
      }
    },
