<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('主数据—APP功能模块')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <wms-app-function-modal ref="modalForm" @ok="modalFormOk"></wms-app-function-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmsAppFunctionModal from './modules/WmsAppFunctionModal'

  export default {
    name: 'WmsAppFunctionList',
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            ...
            sorter: (a, b) => a.appmodelCode - b.appmodelCode
          },
          {
            title: 'app模块名称',
            align: 'left',
        ...
        url: {
          list: '/wmsapp/wmsAppFunction/list',
          delete: '/wmsapp/wmsAppFunction/delete',
          deleteBatch: '/wmsapp/wmsAppFunction/deleteBatch',
          exportXlsUrl: '/wmsapp/wmsAppFunction/exportXls',
          importExcelUrl: '/wmsapp/wmsAppFunction/importExcel'
        },
        dictOptions: {}
      }
    },
