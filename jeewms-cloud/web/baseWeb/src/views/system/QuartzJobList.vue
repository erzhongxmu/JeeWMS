<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('定时任务信息')">{{$t('导出')}}</a-button>
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item><a @click="handleEdit(record)">{{$t('编辑')}}</a></a-menu-item>
              <a-menu-item>
    ...
    methods: {
      ...
      resumeJob: function(record){
        ...
        this.$confirm({
          ...
          content:"是否启动选中任务?",
          onOk: function(){
            getAction(that.url.resume,{jobClassName:record.jobClassName,id:record.id}).then((res)=>{
              if(res.success){
                that.$message.success(this.$t('操作成功'));
                that.loadData();
                that.onClearSelected();
