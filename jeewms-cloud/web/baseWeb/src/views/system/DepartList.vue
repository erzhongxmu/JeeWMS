    ...
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <a-row style="margin-left: 14px">
          ...
          <a-button type="primary" icon="download" @click="handleExportXls('部门信息')">{{$t('导出')}}</a-button>
          <a-upload
            name="file"
          ...
          <a-button title="删除多条数据" @click="batchDel" type="default">{{$t('批量删除')}}</a-button>
          ...
          <a-col :md="10" :sm="24">
            <template>
              <a-dropdown :trigger="[this.dropTrigger]" @visibleChange="dropStatus">
                ...
                <!--新增右键点击事件,和增加添加和删除功能-->
                <a-menu slot="overlay">
                  <a-menu-item @click="handleAdd(3)" key="1">{{$t('添加')}}</a-menu-item>
                  <a-menu-item @click="handleDelete" key="2">{{$t('删除')}}</a-menu-item>
              ...
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="机构类型">
                ...
                <template v-else>
                  <a-radio-group
                    ...
                    placeholder="请选择机构类型"
                  >
                    <a-radio value="2">二级部门</a-radio>
                    <a-radio value="3">三级部门</a-radio>
                  </a-radio-group>
                </template>
              </a-form-item>
