<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('费用名称')">{{$t('导出')}}</a-button>
      <a-upload
        name="file"
    ...
    <bms-cost-modal ref="modalForm" @ok="modalFormOk"></bms-cost-modal>
  </a-card>
</template>
...
import BmsCostModal from './modules/BmsCostModal'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/bms/bmsCost/list',
        delete: '/bms/bmsCost/delete',
        deleteBatch: '/bms/bmsCost/deleteBatch',
        exportXlsUrl: '/bms/bmsCost/exportXls',
        importExcelUrl: 'bms/bmsCost/importExcel'
      },
      dictOptions: {},
      superFieldList: []
    }
  ...
  methods: {
    ...
    getSuperFieldList() {
      let fieldList = []
      fieldList.push({ type: 'string', value: 'costNo', text: '费用编号', dictCode: '' })
