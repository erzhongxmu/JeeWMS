<template>
  <a-card :bordered="false">
    ...
    <di-it-log-modal ref="modalForm" @ok="modalFormOk"></di-it-log-modal>
  </a-card>
</template>
...
import DiItLogModal from './modules/DiItLogModal'
...
export default {
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          title: this.$t('目的执行数据'),
          align: 'center',
          dataIndex: 'diDrundata'
        },
        {
          title: this.$t('目的执行状态'),
          align: 'center',
          dataIndex: 'diDrunstatus'
        }
      ],
      url: {
        list: '/di/diItLog/list',
        delete: '/di/diItLog/delete',
        deleteBatch: '/di/diItLog/deleteBatch',
        exportXlsUrl: '/di/diItLog/exportXls',
        importExcelUrl: 'di/diItLog/importExcel'
      },
      dictOptions: {},
      superFieldList: []
    }
  ...
  methods: {
    ...
    getSuperFieldList() {
      ...
      fieldList.push({ type: 'string', value: 'diDrundata', text: '目的执行数据', dictCode: '' })
      fieldList.push({ type: 'string', value: 'diDrunstatus', text: '目的执行状态', dictCode: '' })
