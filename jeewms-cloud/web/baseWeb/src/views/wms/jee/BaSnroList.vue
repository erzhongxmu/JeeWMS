      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item :label="$t('编号类型')">
              <j-dict-select-tag :placeholder="$t('请输入')" v-model="queryParam.snroTypeCode" dictCode="ba_order_type,order_type_code,order_type_code"/>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item :label="$t('组织机构')">
              <a-input :placeholder="$t('请输入')" v-model="queryParam.snroOrg"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('自动编码')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baSnro-modal ref="modalForm" @ok="modalFormOk"></baSnro-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaSnroModal from './modules/BaSnroModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/baSnro/list",
          delete: "/jeewms/baSnro/delete",
          deleteBatch: "/jeewms/baSnro/deleteBatch",
          exportXlsUrl: "/jeewms/baSnro/exportXls",
          importExcelUrl: "jeewms/baSnro/importExcel",
        },
        dictOptions:{},
      }
    },
