      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="学历代码">
              <a-input placeholder="请输入学历代码" v-model="queryParam.eduStaCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="学历名称">
              <a-input placeholder="请输入学历名称" v-model="queryParam.eduStaName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('ba_edu_sta')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baEduSta-modal ref="modalForm" @ok="modalFormOk"></baEduSta-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaEduStaModal from './modules/BaEduStaModal'
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            title:'学历代码',
            align: 'left',
            dataIndex: 'eduStaCode'
          },
          {
            title:'学历名称',
            align: 'left',
            dataIndex: 'eduStaName'
          }

        ],
        url: {
          list: "/jeewms/baEduSta/list",
          delete: "/jeewms/baEduSta/delete",
          deleteBatch: "/jeewms/baEduSta/deleteBatch",
          exportXlsUrl: "/jeewms/baEduSta/exportXls",
          importExcelUrl: "jeewms/baEduSta/importExcel",
        },
        dictOptions:{},
      }
    },
