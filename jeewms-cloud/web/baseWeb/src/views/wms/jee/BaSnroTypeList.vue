      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item :label="$t('编码类型代码')">
              <a-input :placeholder="$t('请输入')" v-model="queryParam.snroTypeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item :label="$t('编码类型名称')">
              <a-input :placeholder="$t('请输入')" v-model="queryParam.snroTypeName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('编码类型')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baSnroType-modal ref="modalForm" @ok="modalFormOk"></baSnroType-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaSnroTypeModal from './modules/BaSnroTypeModal'
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            title: this.$t('编码类型代码'),
            align: 'left',
            dataIndex: 'snroTypeCode'
          },
          {
            title: this.$t('编码类型名称'),
            align: 'left',
            dataIndex: 'snroTypeName'
          }

        ],
        url: {
          list: "/jeewms/baSnroType/list",
          delete: "/jeewms/baSnroType/delete",
          deleteBatch: "/jeewms/baSnroType/deleteBatch",
          exportXlsUrl: "/jeewms/baSnroType/exportXls",
          importExcelUrl: "jeewms/baSnroType/importExcel",
        },
        dictOptions:{},
      }
    },
