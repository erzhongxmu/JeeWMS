<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('wm_om_delv_h')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <wmOmDelvH-modal ref="modalForm" @ok="modalFormOk"></wmOmDelvH-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmOmDelvHModal from './modules/WmOmDelvHModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/wmOmDelvH/list",
          delete: "/jeewms/wmOmDelvH/delete",
          deleteBatch: "/jeewms/wmOmDelvH/deleteBatch",
          exportXlsUrl: "/jeewms/wmOmDelvH/exportXls",
          importExcelUrl: "jeewms/wmOmDelvH/importExcel",
        },
        dictOptions:{},
      }
    },
