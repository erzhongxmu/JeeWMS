      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="工作状态代码">
              <a-input placeholder="请输入工作状态代码" v-model="queryParam.workStaCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="工作状态名称">
              <a-input placeholder="请输入工作状态名称" v-model="queryParam.workStaName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('ba_work_sta')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baWorkSta-modal ref="modalForm" @ok="modalFormOk"></baWorkSta-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaWorkStaModal from './modules/BaWorkStaModal'
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            title:'工作状态代码',
            align: 'left',
            dataIndex: 'workStaCode'
          },
          {
            title:'工作状态名称',
            align: 'left',
            dataIndex: 'workStaName'
          }

        ],
        url: {
          list: "/jeewms/baWorkSta/list",
          delete: "/jeewms/baWorkSta/delete",
          deleteBatch: "/jeewms/baWorkSta/deleteBatch",
          exportXlsUrl: "/jeewms/baWorkSta/exportXls",
          importExcelUrl: "jeewms/baWorkSta/importExcel",
        },
        dictOptions:{},
      }
    },
