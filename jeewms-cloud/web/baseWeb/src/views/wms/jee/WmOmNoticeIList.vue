<template>
  <a-card :bordered="false" :class="'cust-erp-sub-tab'">
    ...
    <wmOmNoticeI-modal ref="modalForm" @ok="modalFormOk" :mainId="mainId"></wmOmNoticeI-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmOmNoticeIModal from './modules/WmOmNoticeIModal'
