      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="单位类型代码">
              <a-input placeholder="请输入单位类型代码" v-model="queryParam.unitTypeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="单位类型名称">
              <a-input placeholder="请输入单位类型名称" v-model="queryParam.unitTypeName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('单位类型')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baUnitType-modal ref="modalForm" @ok="modalFormOk"></baUnitType-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaUnitTypeModal from './modules/BaUnitTypeModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/baUnitType/list",
          delete: "/jeewms/baUnitType/delete",
          deleteBatch: "/jeewms/baUnitType/deleteBatch",
          exportXlsUrl: "/jeewms/baUnitType/exportXls",
          importExcelUrl: "jeewms/baUnitType/importExcel",
        },
        dictOptions:{},
      }
    },
