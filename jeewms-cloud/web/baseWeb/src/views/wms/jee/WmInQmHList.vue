<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('wm_in_qm_h')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <wmInQmH-modal ref="modalForm" @ok="modalFormOk"></wmInQmH-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmInQmHModal from './modules/WmInQmHModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/wmInQmH/list",
          delete: "/jeewms/wmInQmH/delete",
          deleteBatch: "/jeewms/wmInQmH/deleteBatch",
          exportXlsUrl: "/jeewms/wmInQmH/exportXls",
          importExcelUrl: "jeewms/wmInQmH/importExcel",
        },
        dictOptions:{},
      }
    },
