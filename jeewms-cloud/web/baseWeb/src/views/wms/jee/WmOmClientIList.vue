...
<!--      </a-dropdown>-->
    ...
    <wmOmClientI-modal ref="modalForm" @ok="modalFormOk" :mainId="mainId"></wmOmClientI-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmOmClientIModal from './modules/WmOmClientIModal'
