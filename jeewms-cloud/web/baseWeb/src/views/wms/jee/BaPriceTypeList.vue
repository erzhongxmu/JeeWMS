      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="价格类型代码">
              <a-input placeholder="请输入价格类型代码" v-model="queryParam.priceTypeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="价格类型名称">
              <a-input placeholder="请输入价格类型名称" v-model="queryParam.priceTypeName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('价格类型')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baPriceType-modal ref="modalForm" @ok="modalFormOk"></baPriceType-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaPriceTypeModal from './modules/BaPriceTypeModal'
  import { commonTableRowClass } from '@/mixins/commonTableRowClass'

  export default {
    name: "BaPriceTypeList",
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/baPriceType/list",
          delete: "/jeewms/baPriceType/delete",
          deleteBatch: "/jeewms/baPriceType/deleteBatch",
          exportXlsUrl: "/jeewms/baPriceType/exportXls",
          importExcelUrl: "jeewms/baPriceType/importExcel",
        },
        dictOptions:{},
      }
    },
