      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="在职状态代码">
              <a-input placeholder="请输入在职状态代码" v-model="queryParam.posStaCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="在职状态名称">
              <a-input placeholder="请输入在职状态名称" v-model="queryParam.posStaName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('ba_post_sta')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baPostSta-modal ref="modalForm" @ok="modalFormOk"></baPostSta-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaPostStaModal from './modules/BaPostStaModal'
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            title:'在职状态代码',
            align: 'left',
            dataIndex: 'posStaCode'
          },
          {
            title:'在职状态名称',
            align: 'left',
            dataIndex: 'posStaName'
          }

        ],
        url: {
          list: "/jeewms/baPostSta/list",
          delete: "/jeewms/baPostSta/delete",
          deleteBatch: "/jeewms/baPostSta/deleteBatch",
          exportXlsUrl: "/jeewms/baPostSta/exportXls",
          importExcelUrl: "jeewms/baPostSta/importExcel",
        },
        dictOptions:{},
      }
    },
