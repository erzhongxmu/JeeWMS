<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('wm_his_stock')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <wmHisStock-modal ref="modalForm" @ok="modalFormOk"></wmHisStock-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmHisStockModal from './modules/WmHisStockModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/wmHisStock/list",
          delete: "/jeewms/wmHisStock/delete",
          deleteBatch: "/jeewms/wmHisStock/deleteBatch",
          exportXlsUrl: "/jeewms/wmHisStock/exportXls",
          importExcelUrl: "jeewms/wmHisStock/importExcel",
        },
        dictOptions:{},
      }
    },
