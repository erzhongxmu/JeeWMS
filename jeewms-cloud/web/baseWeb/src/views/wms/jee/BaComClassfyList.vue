      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="行业分类代码">
              <a-input placeholder="请输入行业分类代码" v-model="queryParam.classflCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="行业分类名称">
              <a-input placeholder="请输入行业分类名称" v-model="queryParam.classflName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('行业分类')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baComClassfy-modal ref="modalForm" @ok="modalFormOk"></baComClassfy-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaComClassfyModal from './modules/BaComClassfyModal'
  import {filterMultiDictText} from '@/components/dict/JDictSelectUtil'
  import { commonTableRowClass } from '@/mixins/commonTableRowClass'

  export default {
    name: "BaComClassfyList",
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            title:'行业分类代码',
            align: 'left',
            dataIndex: 'classflCode'
          },
          {
            title:'行业分类名称',
            align: 'left',
            dataIndex: 'classflName'
          }
          // {
          //   title:'状态',
          //   align: 'left',
          //   dataIndex: 'classflDel_dictText'
          // }

        ],
        url: {
          list: "/jeewms/baComClassfy/list",
          delete: "/jeewms/baComClassfy/delete",
          deleteBatch: "/jeewms/baComClassfy/deleteBatch",
          exportXlsUrl: "/jeewms/baComClassfy/exportXls",
          importExcelUrl: "jeewms/baComClassfy/importExcel",
        },
        dictOptions:{},
      }
    },
