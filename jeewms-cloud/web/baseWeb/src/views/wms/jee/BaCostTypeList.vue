      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="费用代码">
              <a-input placeholder="请输入费用代码" v-model="queryParam.costTypeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="费用名称">
              <a-input placeholder="请输入费用名称" v-model="queryParam.costTypeName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('费用类型')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baCostType-modal ref="modalForm" @ok="modalFormOk"></baCostType-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaCostTypeModal from './modules/BaCostTypeModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/baCostType/list",
          delete: "/jeewms/baCostType/delete",
          deleteBatch: "/jeewms/baCostType/deleteBatch",
          exportXlsUrl: "/jeewms/baCostType/exportXls",
          importExcelUrl: "jeewms/baCostType/importExcel",
        },
        dictOptions:{},
      }
    },
