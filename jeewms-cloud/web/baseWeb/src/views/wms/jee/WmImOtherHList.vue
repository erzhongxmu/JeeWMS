    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-popconfirm v-if="record.imSta == '计划中'" :title="$t('你确定吗?')" @confirm="() => handleDelete(record.id)">
            <a>{{$t('删除')}}</a>
          </a-popconfirm>
<!--          <a-dropdown>-->
...
<!--          </a-dropdown>-->
    ...
    <wmImOtherH-modal ref="modalForm" @ok="modalFormOk"></wmImOtherH-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmImOtherHModal from './modules/WmImOtherHModal'
