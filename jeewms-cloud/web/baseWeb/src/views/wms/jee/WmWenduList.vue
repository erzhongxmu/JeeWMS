<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('wm_wendu')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <wmWendu-modal ref="modalForm" @ok="modalFormOk"></wmWendu-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmWenduModal from './modules/WmWenduModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/wmWendu/list",
          delete: "/jeewms/wmWendu/delete",
          deleteBatch: "/jeewms/wmWendu/deleteBatch",
          exportXlsUrl: "/jeewms/wmWendu/exportXls",
          importExcelUrl: "jeewms/wmWendu/importExcel",
        },
        dictOptions:{},
      }
    },
