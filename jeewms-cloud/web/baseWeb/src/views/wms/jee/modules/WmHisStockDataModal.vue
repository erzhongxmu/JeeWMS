  ...
  <j-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="proData" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['proData']" placeholder="请输入proData"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/jeewms/wmHisStockData/add",
          edit: "/jeewms/wmHisStockData/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'hisDate','cusCode','kuWeiBianMa','binId','goodsId','count','baseUnit','cusName','proData'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'hisDate','cusCode','kuWeiBianMa','binId','goodsId','count','baseUnit','cusName','proData'))
      },
