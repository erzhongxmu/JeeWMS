    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="复核时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="请选择复核时间" v-decorator="['fhData']" :trigger-change="true" style="width: 100%"/>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/jeewms/wmOmDelvH/add",
          edit: "/jeewms/wmOmDelvH/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'createName','createBy','createDate','updateName','updateBy','updateDate','sysOrgCode','sysCompanyCode','delvBeizhu','wmOmNoticeId','fhData','cusCode','fhSta'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'createName','createBy','createDate','updateName','updateBy','updateDate','sysOrgCode','sysCompanyCode','delvBeizhu','wmOmNoticeId','fhData','cusCode','fhSta'))
      },
