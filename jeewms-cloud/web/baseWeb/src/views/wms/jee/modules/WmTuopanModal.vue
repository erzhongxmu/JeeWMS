  ...
  <j-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="托盘号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['tinId']" placeholder="请输入托盘号"></a-input>
        </a-form-item>
        <a-form-item label="托盘顺序" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['tinSort']" placeholder="请输入托盘顺序"></a-input>
        </a-form-item>
        <a-form-item label="库位" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['binId']" placeholder="请输入库位"></a-input>
        </a-form-item>
        <a-form-item label="托盘状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['tinStatus']" placeholder="请输入托盘状态"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/jeewms/wmTuopan/add",
          edit: "/jeewms/wmTuopan/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'createName','createBy','createDate','updateName','updateBy','updateDate','sysOrgCode','sysCompanyCode','bpmStatus','tinId','tinSort','binId','tinStatus'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'createName','createBy','createDate','updateName','updateBy','updateDate','sysOrgCode','sysCompanyCode','bpmStatus','tinId','tinSort','binId','tinStatus'))
      },
