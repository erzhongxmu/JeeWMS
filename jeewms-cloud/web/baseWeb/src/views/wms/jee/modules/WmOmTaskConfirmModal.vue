  ...
  <j-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item :label="$t('货主')" :labelCol="labelCol" :wrapperCol="wrapperCol">
        ...
        <!-- <a-form-item :label="$t('出货数量')" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['omQuat']" :placeholder="$t('请输入')" :disabled="title==$t('查看')?true:false"></a-input>
        </a-form-item> -->
        
        <a-form-item :label="$t('入库日期')" :labelCol="labelCol" :wrapperCol="wrapperCol">
        ...
        <a-form-item :label="$t('库位')" :labelCol="labelCol" :wrapperCol="wrapperCol">
        ...
        <!-- <a-form-item :label="$t('是否已下架')" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="radio" v-decorator="['binSta']" :trigger-change="true" dictCode="sf_yn" :placeholder="$t('请选择')" :disabled="title==$t('查看')?true:false"/>
        </a-form-item> -->
...
<!--        </a-form-item>-->
        <!-- <a-form-item :label="$t('任务接收人')" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['assignTo']" :trigger-change="true" dictCode="sys_user,username,username" :placeholder="$t('请选择')" :disabled="title==$t('查看')?true:false"/>
        </a-form-item> -->
...
<!--        </a-form-item>-->
        <!-- <a-form-item :label="$t('波次编号')" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['waveId']" :placeholder="$t('请输入')" :disabled="title==$t('查看')?true:false"></a-input>
        </a-form-item> -->
        <!-- <a-form-item :label="$t('订单号')" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['imCusCode']" :placeholder="$t('请输入')" :disabled="title==$t('查看')?true:false"></a-input>
        </a-form-item> -->
...
<script>
  ...
  export default {
    ...
    methods: {
      getJobPersonList(goodsType) {
        return
        postAction(this.url.getJobPersonList, [goodsType]).then((res) => {
          if (res.success) {
      ...
      edit (record) {
        ...
        this.getJobPersonList(record.goodsTypeId)
