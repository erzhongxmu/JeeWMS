  ...
  <j-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="到货通知ID" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['imNoticeId']" placeholder="请输入到货通知ID"></a-input>
        </a-form-item>
        <a-form-item label="月台" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['imPlatformId']" placeholder="请输入月台"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/jeewms/wmInQmH/add",
          edit: "/jeewms/wmInQmH/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'createName','createBy','createDate','updateName','updateBy','updateDate','sysOrgCode','sysCompanyCode','imNoticeId','imPlatformId','imCarNo','cusCode'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'createName','createBy','createDate','updateName','updateBy','updateDate','sysOrgCode','sysCompanyCode','imNoticeId','imPlatformId','imCarNo','cusCode'))
      },
