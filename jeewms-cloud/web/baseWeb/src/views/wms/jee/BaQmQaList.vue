      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item :label="$t('品质代码')">
              <a-input  :placeholder="$t('请输入')" v-model="queryParam.qmQaCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item :label="$t('品质代码名称')">
              <a-input :placeholder="$t('请输入')" v-model="queryParam.qmQaName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls($t('品质代码'))">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baQmQa-modal ref="modalForm" @ok="modalFormOk"></baQmQa-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaQmQaModal from './modules/BaQmQaModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/baQmQa/list",
          delete: "/jeewms/baQmQa/delete",
          deleteBatch: "/jeewms/baQmQa/deleteBatch",
          exportXlsUrl: "/jeewms/baQmQa/exportXls",
          importExcelUrl: "jeewms/baQmQa/importExcel",
        },
        dictOptions:{},
      }
    },
