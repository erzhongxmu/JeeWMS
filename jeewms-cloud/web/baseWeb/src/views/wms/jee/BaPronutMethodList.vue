      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="计费方式代码">
              <a-input placeholder="请输入计费方式代码" v-model="queryParam.pronutCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="计费方式名称">
              <a-input placeholder="请输入计费方式名称" v-model="queryParam.pronutName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('计费方式')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baPronutMethod-modal ref="modalForm" @ok="modalFormOk"></baPronutMethod-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaPronutMethodModal from './modules/BaPronutMethodModal'
  import { commonTableRowClass } from '@/mixins/commonTableRowClass'

  export default {
    name: "BaPronutMethodList",
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            title:'计费方式代码',
            align: 'left',
            dataIndex: 'pronutCode'
          },
          {
            title:'计费方式名称',
            align: 'left',
            dataIndex: 'pronutName'
          }

        ],
        url: {
          list: "/jeewms/baPronutMethod/list",
          delete: "/jeewms/baPronutMethod/delete",
          deleteBatch: "/jeewms/baPronutMethod/deleteBatch",
          exportXlsUrl: "/jeewms/baPronutMethod/exportXls",
          importExcelUrl: "jeewms/baPronutMethod/importExcel",
        },
        dictOptions:{},
      }
    },
