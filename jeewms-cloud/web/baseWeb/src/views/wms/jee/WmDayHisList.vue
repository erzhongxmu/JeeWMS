<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('wm_day_his')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <wmDayHis-modal ref="modalForm" @ok="modalFormOk"></wmDayHis-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmDayHisModal from './modules/WmDayHisModal'
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title:'hisDayAmount',
            align: 'left',
            dataIndex: 'hisDayAmount'
          }

        ],
        url: {
          list: "/jeewms/wmDayHis/list",
          delete: "/jeewms/wmDayHis/delete",
          deleteBatch: "/jeewms/wmDayHis/deleteBatch",
          exportXlsUrl: "/jeewms/wmDayHis/exportXls",
          importExcelUrl: "jeewms/wmDayHis/importExcel",
        },
        dictOptions:{},
      }
    },
