...
<!--      </a-dropdown>-->
    ...
    <WmReturnNoticeI-modal ref="modalForm" @ok="modalFormOk" :mainId="mainId"></WmReturnNoticeI-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmReturnNoticeIModal from './modules/WmReturnNoticeIModal'
  ...
  export default {
    ...
    components: { WmReturnNoticeIModal },
    props:{
      mainId:{
        type:String,
        default:'',
