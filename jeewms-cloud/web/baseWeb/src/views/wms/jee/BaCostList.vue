<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="费用代码">
              <a-input placeholder="请输入费用代码" v-model="queryParam.costCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
          ...
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="费用类型">
                <a-input placeholder="请输入费用类型" v-model="queryParam.costTypeCode"></a-input>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('ba_cost')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baCost-modal ref="modalForm" @ok="modalFormOk"></baCost-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaCostModal from './modules/BaCostModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/baCost/list",
          delete: "/jeewms/baCost/delete",
          deleteBatch: "/jeewms/baCost/deleteBatch",
          exportXlsUrl: "/jeewms/baCost/exportXls",
          importExcelUrl: "jeewms/baCost/importExcel",
        },
        dictOptions:{},
      }
    },
