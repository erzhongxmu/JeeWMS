<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('wm_tuopan')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <wmTuopan-modal ref="modalForm" @ok="modalFormOk"></wmTuopan-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmTuopanModal from './modules/WmTuopanModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/wmTuopan/list",
          delete: "/jeewms/wmTuopan/delete",
          deleteBatch: "/jeewms/wmTuopan/deleteBatch",
          exportXlsUrl: "/jeewms/wmTuopan/exportXls",
          importExcelUrl: "jeewms/wmTuopan/importExcel",
        },
        dictOptions:{},
      }
    },
