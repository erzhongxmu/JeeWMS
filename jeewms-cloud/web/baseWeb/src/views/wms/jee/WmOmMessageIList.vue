...
<!--      </a-dropdown>-->
    ...
    <wmOmMessageI-modal ref="modalForm" @ok="modalFormOk" :mainId="mainId"></wmOmMessageI-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmOmMessageIModal from './modules/WmOmMessageIModal'
