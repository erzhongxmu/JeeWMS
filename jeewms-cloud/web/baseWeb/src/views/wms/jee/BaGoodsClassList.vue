      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="计费商品类代码">
              <a-input placeholder="请输入计费商品类代码" v-model="queryParam.goodsClassCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="计费商品类名称">
              <a-input placeholder="请输入计费商品类名称" v-model="queryParam.goodsClassName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('计费商品类')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baGoodsClass-modal ref="modalForm" @ok="modalFormOk"></baGoodsClass-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaGoodsClassModal from './modules/BaGoodsClassModal'
  import { commonTableRowClass } from '@/mixins/commonTableRowClass'

  export default {
    name: "BaGoodsClassList",
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/baGoodsClass/list",
          delete: "/jeewms/baGoodsClass/delete",
          deleteBatch: "/jeewms/baGoodsClass/deleteBatch",
          exportXlsUrl: "/jeewms/baGoodsClass/exportXls",
          importExcelUrl: "jeewms/baGoodsClass/importExcel",
        },
        dictOptions:{},
      }
    },
