      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="提货方式代码">
              <a-input placeholder="请输入提货方式代码" v-model="queryParam.ladModeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="提货方式名称">
              <a-input placeholder="请输入提货方式名称" v-model="queryParam.ladModeName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('提货方式')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baLadMode-modal ref="modalForm" @ok="modalFormOk"></baLadMode-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaLadModeModal from './modules/BaLadModeModal'
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            title:'提货方式代码',
            align: 'left',
            dataIndex: 'ladModeCode'
          },
          {
            title:'提货方式名称',
            align: 'left',
            dataIndex: 'ladModeName'
          }

        ],
        url: {
          list: "/jeewms/baLadMode/list",
          delete: "/jeewms/baLadMode/delete",
          deleteBatch: "/jeewms/baLadMode/deleteBatch",
          exportXlsUrl: "/jeewms/baLadMode/exportXls",
          importExcelUrl: "jeewms/baLadMode/importExcel",
        },
        dictOptions:{},
      }
    },
