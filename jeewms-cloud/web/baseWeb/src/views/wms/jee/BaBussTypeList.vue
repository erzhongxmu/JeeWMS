<template>
  <a-card :bordered="false">
      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="业务类型代码">
              <a-input placeholder="请输入业务类型代码" v-model="queryParam.bussTypeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="业务类型名称">
              <a-input placeholder="请输入业务类型名称" v-model="queryParam.bussTypeName"></a-input>
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="业务类型备注">
                <a-input placeholder="请输入业务类型备注" v-model="queryParam.bussTypeText"></a-input>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('业务类型')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baBussType-modal ref="modalForm" @ok="modalFormOk"></baBussType-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaBussTypeModal from './modules/BaBussTypeModal'
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title:'业务类型备注',
            align: 'left',
            dataIndex: 'bussTypeText'
          }

        ],
        url: {
          list: "/jeewms/baBussType/list",
          delete: "/jeewms/baBussType/delete",
          deleteBatch: "/jeewms/baBussType/deleteBatch",
          exportXlsUrl: "/jeewms/baBussType/exportXls",
          importExcelUrl: "jeewms/baBussType/importExcel",
        },
        dictOptions:{},
      }
    },
