      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="系统参数类型代码">
              <a-input placeholder="请输入系统参数类型代码" v-model="queryParam.syspTypeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="系统参数类型名称">
              <a-input placeholder="请输入系统参数类型名称" v-model="queryParam.syspTypeName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('参数类型')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baSyspType-modal ref="modalForm" @ok="modalFormOk"></baSyspType-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaSyspTypeModal from './modules/BaSyspTypeModal'
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            title:'系统参数类型代码',
            align: 'left',
            dataIndex: 'syspTypeCode'
          },
          {
            title:'系统参数类型名称',
            align: 'left',
            dataIndex: 'syspTypeName'
          }

        ],
        url: {
          list: "/jeewms/baSyspType/list",
          delete: "/jeewms/baSyspType/delete",
          deleteBatch: "/jeewms/baSyspType/deleteBatch",
          exportXlsUrl: "/jeewms/baSyspType/exportXls",
          importExcelUrl: "jeewms/baSyspType/importExcel",
        },
        dictOptions:{},
      }
    },
