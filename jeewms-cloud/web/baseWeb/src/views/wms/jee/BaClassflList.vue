...
<!--      </a-dropdown>-->
    ...
    <baClassfl-modal ref="modalForm" @ok="modalFormOk"></baClassfl-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaClassflModal from './modules/BaClassflModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/baClassfl/list",
          delete: "/jeewms/baClassfl/delete",
          deleteBatch: "/jeewms/baClassfl/deleteBatch",
          exportXlsUrl: "/jeewms/baClassfl/exportXls",
          importExcelUrl: "jeewms/baClassfl/importExcel",
        },
        dictOptions:{},
      }
    },
