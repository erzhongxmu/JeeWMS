<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('wm_his_stock_data')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <wmHisStockData-modal ref="modalForm" @ok="modalFormOk"></wmHisStockData-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmHisStockDataModal from './modules/WmHisStockDataModal'

  export default {
    name: "WmHisStockDataList",
    ...
    data () {
      return {
        description: 'wm_his_stock_data管理页面',
        // 表头
        columns: [
          {
            title: this.$t('操作'),
        ...
        url: {
          list: "/jeewms/wmHisStockData/list",
          delete: "/jeewms/wmHisStockData/delete",
          deleteBatch: "/jeewms/wmHisStockData/deleteBatch",
          exportXlsUrl: "/jeewms/wmHisStockData/exportXls",
          importExcelUrl: "jeewms/wmHisStockData/importExcel",
        },
        dictOptions:{},
      }
    },
