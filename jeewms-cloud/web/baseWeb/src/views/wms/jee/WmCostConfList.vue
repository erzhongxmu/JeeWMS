<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('wm_cost_conf')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <wmCostConf-modal ref="modalForm" @ok="modalFormOk"></wmCostConf-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmCostConfModal from './modules/WmCostConfModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/wmCostConf/list",
          delete: "/jeewms/wmCostConf/delete",
          deleteBatch: "/jeewms/wmCostConf/deleteBatch",
          exportXlsUrl: "/jeewms/wmCostConf/exportXls",
          importExcelUrl: "jeewms/wmCostConf/importExcel",
        },
        dictOptions:{},
      }
    },
