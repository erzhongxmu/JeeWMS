      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="城市类型代码">
              <a-input placeholder="请输入城市类型代码" v-model="queryParam.cityTypeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="城市类型名称">
              <a-input placeholder="请输入城市类型名称" v-model="queryParam.cityTypeName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('城市类型')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baCityType-modal ref="modalForm" @ok="modalFormOk"></baCityType-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaCityTypeModal from './modules/BaCityTypeModal'
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            title:'城市类型代码',
            align: 'left',
            dataIndex: 'cityTypeCode'
          },
          {
            title:'城市类型名称',
            align: 'left',
            dataIndex: 'cityTypeName'
          }

        ],
        url: {
          list: "/jeewms/baCityType/list",
          delete: "/jeewms/baCityType/delete",
          deleteBatch: "/jeewms/baCityType/deleteBatch",
          exportXlsUrl: "/jeewms/baCityType/exportXls",
          importExcelUrl: "jeewms/baCityType/importExcel",
        },
        dictOptions:{},
      }
    },
