      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="接货方式代码">
              <a-input placeholder="请输入接货方式代码" v-model="queryParam.delModeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="接货方式名称">
              <a-input placeholder="请输入接货方式名称" v-model="queryParam.delModeName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('接货方式')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baDelMode-modal ref="modalForm" @ok="modalFormOk"></baDelMode-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaDelModeModal from './modules/BaDelModeModal'
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            title:'接货方式代码',
            align: 'left',
            dataIndex: 'delModeCode'
          },
          {
            title:'接货方式名称',
            align: 'left',
            dataIndex: 'delModeName'
          }

        ],
        url: {
          list: "/jeewms/baDelMode/list",
          delete: "/jeewms/baDelMode/delete",
          deleteBatch: "/jeewms/baDelMode/deleteBatch",
          exportXlsUrl: "/jeewms/baDelMode/exportXls",
          importExcelUrl: "jeewms/baDelMode/importExcel",
        },
        dictOptions:{},
      }
    },
