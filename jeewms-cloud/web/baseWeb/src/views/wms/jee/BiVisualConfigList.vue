<template>
  <a-card :bordered="false">
      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="可视化表主键">
              <a-input placeholder="请输入可视化表主键" v-model="queryParam.visualId"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('大屏配置')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <biVisualConfig-modal ref="modalForm" @ok="modalFormOk"></biVisualConfig-modal>
  </a-card>
</template>
...
<script>
  ...
  import BiVisualConfigModal from './modules/BiVisualConfigModal'

  export default {
    name: "BiVisualConfigList",
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/biVisualConfig/list",
          delete: "/jeewms/biVisualConfig/delete",
          deleteBatch: "/jeewms/biVisualConfig/deleteBatch",
          exportXlsUrl: "/jeewms/biVisualConfig/exportXls",
          importExcelUrl: "jeewms/biVisualConfig/importExcel",
        },
        dictOptions:{},
      }
    },
