      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="大区代码">
              <a-input placeholder="请输入大区代码" v-model="queryParam.areaCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="大区名称">
              <a-input placeholder="请输入大区名称" v-model="queryParam.areaName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('大区信息')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baArea-modal ref="modalForm" @ok="modalFormOk"></baArea-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaAreaModal from './modules/BaAreaModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/baArea/list",
          delete: "/jeewms/baArea/delete",
          deleteBatch: "/jeewms/baArea/deleteBatch",
          exportXlsUrl: "/jeewms/baArea/exportXls",
          importExcelUrl: "jeewms/baArea/importExcel",
        },
        dictOptions:{},
      }
    },
