<template>
  <a-card :bordered="false">
      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="作业类型代码">
              <a-input placeholder="请输入作业类型代码" v-model="queryParam.actTypeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="作业类型名称">
              <a-input placeholder="请输入作业类型名称" v-model="queryParam.actTypeName"></a-input>
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="业务环节">
                <j-dict-select-tag placeholder="请选择业务环节" v-model="queryParam.operStepCode" dictCode="ba_oper_step,oper_step_name,oper_step_code"/>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('作业类型')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baActType-modal ref="modalForm" @ok="modalFormOk"></baActType-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaActTypeModal from './modules/BaActTypeModal'
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title:'业务环节',
            align: 'left',
            dataIndex: 'operStepCode_dictText'
          }
        ],
        url: {
          list: "/jeewms/baActType/list",
          delete: "/jeewms/baActType/delete",
          deleteBatch: "/jeewms/baActType/deleteBatch",
          exportXlsUrl: "/jeewms/baActType/exportXls",
          importExcelUrl: "jeewms/baActType/importExcel",
        },
        dictOptions:{},
      }
    },
