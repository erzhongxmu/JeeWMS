      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="计量类型代码">
              <a-input placeholder="请输入计量类型代码" v-model="queryParam.pronutTypeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="计量类型名称">
              <a-input placeholder="请输入计量类型名称" v-model="queryParam.pronutTypeName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('计量类型')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baPronutType-modal ref="modalForm" @ok="modalFormOk"></baPronutType-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaPronutTypeModal from './modules/BaPronutTypeModal'
  import { commonTableRowClass } from '@/mixins/commonTableRowClass'

  export default {
    name: "BaPronutTypeList",
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            title:'计量类型代码',
            align: 'left',
            dataIndex: 'pronutTypeCode'
          },
          {
            title:'计量类型名称',
            align: 'left',
            dataIndex: 'pronutTypeName'
          }

        ],
        url: {
          list: "/jeewms/baPronutType/list",
          delete: "/jeewms/baPronutType/delete",
          deleteBatch: "/jeewms/baPronutType/deleteBatch",
          exportXlsUrl: "/jeewms/baPronutType/exportXls",
          importExcelUrl: "jeewms/baPronutType/importExcel",
        },
        dictOptions:{},
      }
    },
