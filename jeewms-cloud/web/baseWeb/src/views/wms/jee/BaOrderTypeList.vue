      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="订单类型代码">
              <a-input placeholder="请输入订单类型代码" v-model="queryParam.orderTypeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="订单类型名称">
              <a-input placeholder="请输入订单类型名称" v-model="queryParam.orderTypeName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('订单类型')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baOrderType-modal ref="modalForm" @ok="modalFormOk"></baOrderType-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaOrderTypeModal from './modules/BaOrderTypeModal'
  import { commonTableRowClass } from '@/mixins/commonTableRowClass'

  export default {
    name: "BaOrderTypeList",
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/baOrderType/list",
          delete: "/jeewms/baOrderType/delete",
          deleteBatch: "/jeewms/baOrderType/deleteBatch",
          exportXlsUrl: "/jeewms/baOrderType/exportXls",
          importExcelUrl: "jeewms/baOrderType/importExcel",
        },
        dictOptions:{},
      }
    },
