      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="温层代码">
              <a-input placeholder="请输入温层代码" v-model="queryParam.degTypeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="温层名称">
              <a-input placeholder="请输入温层名称" v-model="queryParam.degTypeName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('温度属性')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baDegType-modal ref="modalForm" @ok="modalFormOk"></baDegType-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaDegTypeModal from './modules/BaDegTypeModal'
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            title:'温层代码',
            align: 'left',
            dataIndex: 'degTypeCode'
          },
          {
            title:'温层名称',
            align: 'left',
            dataIndex: 'degTypeName'
          }

        ],
        url: {
          list: "/jeewms/baDegType/list",
          delete: "/jeewms/baDegType/delete",
          deleteBatch: "/jeewms/baDegType/deleteBatch",
          exportXlsUrl: "/jeewms/baDegType/exportXls",
          importExcelUrl: "jeewms/baDegType/importExcel",
        },
        dictOptions:{},
      }
    },
