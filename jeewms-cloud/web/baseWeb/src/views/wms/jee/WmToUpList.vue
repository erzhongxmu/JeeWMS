<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('wm_to_up')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <wmToUp-modal ref="modalForm" @ok="modalFormOk"></wmToUp-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmToUpModal from './modules/WmToUpModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/wmToUp/list",
          delete: "/jeewms/wmToUp/delete",
          deleteBatch: "/jeewms/wmToUp/deleteBatch",
          exportXlsUrl: "/jeewms/wmToUp/exportXls",
          importExcelUrl: "jeewms/wmToUp/importExcel",
        },
        dictOptions:{},
      }
    },
