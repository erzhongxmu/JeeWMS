      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="性别代码">
              <a-input placeholder="请输入性别代码" v-model="queryParam.sexStaCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="性别名称">
              <a-input placeholder="请输入性别名称" v-model="queryParam.sexStaName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('ba_sex_sta')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baSexSta-modal ref="modalForm" @ok="modalFormOk"></baSexSta-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaSexStaModal from './modules/BaSexStaModal'
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            title:'性别代码',
            align: 'left',
            dataIndex: 'sexStaCode'
          },
          {
            title:'性别名称',
            align: 'left',
            dataIndex: 'sexStaName'
          }

        ],
        url: {
          list: "/jeewms/baSexSta/list",
          delete: "/jeewms/baSexSta/delete",
          deleteBatch: "/jeewms/baSexSta/deleteBatch",
          exportXlsUrl: "/jeewms/baSexSta/exportXls",
          importExcelUrl: "jeewms/baSexSta/importExcel",
        },
        dictOptions:{},
      }
    },
