      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="箱型代码">
              <a-input placeholder="请输入箱型代码" v-model="queryParam.contTypeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="箱型名称">
              <a-input placeholder="请输入箱型名称" v-model="queryParam.contTypeName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('箱型')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baContType-modal ref="modalForm" @ok="modalFormOk"></baContType-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaContTypeModal from './modules/BaContTypeModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/baContType/list",
          delete: "/jeewms/baContType/delete",
          deleteBatch: "/jeewms/baContType/deleteBatch",
          exportXlsUrl: "/jeewms/baContType/exportXls",
          importExcelUrl: "jeewms/baContType/importExcel",
        },
        dictOptions:{},
      }
    },
