      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="品牌代码">
              <a-input placeholder="请输入品牌代码" v-model="queryParam.goodsBrandCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="品牌名称">
              <a-input placeholder="请输入品牌名称" v-model="queryParam.goodsBrandName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('商品品牌')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baGoodsBrand-modal ref="modalForm" @ok="modalFormOk"></baGoodsBrand-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaGoodsBrandModal from './modules/BaGoodsBrandModal'
  import {filterMultiDictText} from '@/components/dict/JDictSelectUtil'
  import { commonTableRowClass } from '@/mixins/commonTableRowClass'

  export default {
    name: "BaGoodsBrandList",
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title:'品牌网址',
            align: 'left',
            dataIndex: 'goodsBrandWww'
          },
          {
            title:'品牌图片',
            align: 'left',
            dataIndex: 'goodsBrandPic',
            scopedSlots: {customRender: 'imgSlot'}
          },
          {
            title:'备注',
            align: 'left',
            dataIndex: 'goodsBrandText'
          },
          {
            title:'停用',
            align: 'left',
            dataIndex: 'goodsBrandDel_dictText'
          }

        ],
        url: {
          list: "/jeewms/baGoodsBrand/list",
          delete: "/jeewms/baGoodsBrand/delete",
          deleteBatch: "/jeewms/baGoodsBrand/deleteBatch",
          exportXlsUrl: "/jeewms/baGoodsBrand/exportXls",
          importExcelUrl: "jeewms/baGoodsBrand/importExcel",
        },
        dictOptions:{},
      }
    },
