        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="港口代码">
              <a-input placeholder="请输入港口代码" v-model="queryParam.portCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="中文名称">
              <a-input placeholder="请输入中文名称" v-model="queryParam.portZhName"></a-input>
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="英文名称">
                <a-input placeholder="请输入英文名称" v-model="queryParam.portEnName"></a-input>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="港口三字代码">
                <a-input placeholder="请输入港口三字代码" v-model="queryParam.portThCode"></a-input>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('港口信息')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baPort-modal ref="modalForm" @ok="modalFormOk"></baPort-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaPortModal from './modules/BaPortModal'
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title:'中文名称',
            align: 'left',
            dataIndex: 'portZhName'
          },
          {
            title:'英文名称',
            align: 'left',
            dataIndex: 'portEnName'
          },
          {
            title:'港口三字代码',
            align: 'left',
            dataIndex: 'portThCode'
          },
          {
            title:'港口UNCODE',
            align: 'left',
          ...
          // },
          {
            title:'停用',
            align: 'left',
            dataIndex: 'portDel_dictText'
          }

        ],
        url: {
          list: "/jeewms/baPort/list",
          delete: "/jeewms/baPort/delete",
          deleteBatch: "/jeewms/baPort/deleteBatch",
          exportXlsUrl: "/jeewms/baPort/exportXls",
          importExcelUrl: "jeewms/baPort/importExcel",
        },
        dictOptions:{},
      }
    },
