      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="操作类型代码">
              <a-input placeholder="请输入操作类型代码" v-model="queryParam.operTypeCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="操作类型名称">
              <a-input placeholder="请输入操作类型名称" v-model="queryParam.operTypeName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('操作类型')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baOperType-modal ref="modalForm" @ok="modalFormOk"></baOperType-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaOperTypeModal from './modules/BaOperTypeModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/baOperType/list",
          delete: "/jeewms/baOperType/delete",
          deleteBatch: "/jeewms/baOperType/deleteBatch",
          exportXlsUrl: "/jeewms/baOperType/exportXls",
          importExcelUrl: "jeewms/baOperType/importExcel",
        },
        dictOptions:{},
      }
    },
