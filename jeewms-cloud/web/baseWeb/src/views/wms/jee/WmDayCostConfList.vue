      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="计费日期">
              <j-date placeholder="请选择计费日期" v-model="queryParam.costDate"></j-date>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="是否已计费">
              <j-dict-select-tag placeholder="请选择是否已计费" v-model="queryParam.costSf" dictCode="sf_yn"/>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('计费日期')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <wmDayCostConf-modal ref="modalForm" @ok="modalFormOk"></wmDayCostConf-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmDayCostConfModal from './modules/WmDayCostConfModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/wmDayCostConf/list",
          delete: "/jeewms/wmDayCostConf/delete",
          deleteBatch: "/jeewms/wmDayCostConf/deleteBatch",
          exportXlsUrl: "/jeewms/wmDayCostConf/exportXls",
          importExcelUrl: "jeewms/wmDayCostConf/importExcel",
        },
        dictOptions:{},
      }
    },
