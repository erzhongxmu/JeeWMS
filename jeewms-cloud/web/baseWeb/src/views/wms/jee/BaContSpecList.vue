      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="箱规代码">
              <a-input placeholder="请输入箱规代码" v-model="queryParam.contSpecCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="箱规名称">
              <a-input placeholder="请输入箱规名称" v-model="queryParam.contSpecName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('箱规')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baContSpec-modal ref="modalForm" @ok="modalFormOk"></baContSpec-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaContSpecModal from './modules/BaContSpecModal'
      ...
      return {
        ...
        columns: [
          ...
          // },
          {
            title:'箱规代码',
            align: 'left',
            dataIndex: 'contSpecCode'
          },
          {
            title:'箱规名称',
            align: 'left',
            dataIndex: 'contSpecName'
          }

        ],
        url: {
          list: "/jeewms/baContSpec/list",
          delete: "/jeewms/baContSpec/delete",
          deleteBatch: "/jeewms/baContSpec/deleteBatch",
          exportXlsUrl: "/jeewms/baContSpec/exportXls",
          importExcelUrl: "jeewms/baContSpec/importExcel",
        },
        dictOptions:{},
      }
    },
