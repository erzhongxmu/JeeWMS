...
<!--      </a-dropdown>-->
    ...
    <wmOmQmSecond-modal ref="modalForm" @ok="modalFormOk" :mainId="mainId"></wmOmQmSecond-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmOmQmSecondModal from './modules/WmOmQmSecondModal'
