<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('wm_his_stock_ku')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <wmHisStockKu-modal ref="modalForm" @ok="modalFormOk"></wmHisStockKu-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmHisStockKuModal from './modules/WmHisStockKuModal'

  export default {
    name: "WmHisStockKuList",
    ...
    data () {
      return {
        description: 'wm_his_stock_ku管理页面',
        // 表头
        columns: [
          {
            title: this.$t('操作'),
        ...
        url: {
          list: "/jeewms/wmHisStockKu/list",
          delete: "/jeewms/wmHisStockKu/delete",
          deleteBatch: "/jeewms/wmHisStockKu/deleteBatch",
          exportXlsUrl: "/jeewms/wmHisStockKu/exportXls",
          importExcelUrl: "jeewms/wmHisStockKu/importExcel",
        },
        dictOptions:{},
      }
    },
