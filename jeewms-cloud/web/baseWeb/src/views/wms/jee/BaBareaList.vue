      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="片区代码">
              <a-input placeholder="请输入片区代码" v-model="queryParam.bareaCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="片区名称">
              <a-input placeholder="请输入片区名称" v-model="queryParam.bareaName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('片区信息')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baBarea-modal ref="modalForm" @ok="modalFormOk"></baBarea-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaBareaModal from './modules/BaBareaModal'
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title:'回单时限',
            align: 'left',
            dataIndex: 'bareaRdata'
          }
        ],
        url: {
          list: "/jeewms/baBarea/list",
          delete: "/jeewms/baBarea/delete",
          deleteBatch: "/jeewms/baBarea/deleteBatch",
          exportXlsUrl: "/jeewms/baBarea/exportXls",
          importExcelUrl: "jeewms/baBarea/importExcel",
        },
        dictOptions:{},
      }
    },
