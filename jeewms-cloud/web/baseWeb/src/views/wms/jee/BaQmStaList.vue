      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="品检状态代码">
              <a-input placeholder="请输入品检状态代码" v-model="queryParam.qmStaCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="品检状态名称">
              <a-input placeholder="请输入品检状态名称" v-model="queryParam.qmStaName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('品检状态')">{{$t('导出')}}</a-button>
...
<!--      </a-dropdown>-->
    ...
    <baQmSta-modal ref="modalForm" @ok="modalFormOk"></baQmSta-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaQmStaModal from './modules/BaQmStaModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeewms/baQmSta/list",
          delete: "/jeewms/baQmSta/delete",
          deleteBatch: "/jeewms/baQmSta/deleteBatch",
          exportXlsUrl: "/jeewms/baQmSta/exportXls",
          importExcelUrl: "jeewms/baQmSta/importExcel",
        },
        dictOptions:{},
      }
    },
