      ...
      <a-row type="flex" justify="start" :gutter="3">
        <a-col :sm="24" :lg="12">
          <a-card>
            ...
            <a-table
              :class="'my-index-table tytable1 j-table-force-nowrap'"
              ref="table1"
              size="small"
              rowKey="id"
              :columns="columns"
        ...
        <a-col :sm="24" :lg="12">
          <a-card>
            ...
            <a-table
              :class="'my-index-table tytable2 j-table-force-nowrap'"
              ref="table2"
              size="small"
              rowKey="id"
              :columns="columns"
        ...
        <a-col :sm="24" :lg="12">
          <a-card>
            ...
            <a-table
              :class="'my-index-table tytable4 j-table-force-nowrap'"
              ref="table4"
              size="small"
              rowKey="id"
              :columns="columns"
        ...
        <a-col :sm="24" :lg="12">
          <a-card>
            ...
            <a-table
              :class="'my-index-table tytable3 j-table-force-nowrap'"
              ref="table3"
              size="small"
              rowKey="id"
              :columns="columns"
