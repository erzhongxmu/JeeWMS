      ...
      <div class="table-page-search-wrapper">
        <a-form layout="inline" @keyup.enter.native="handleSearch">
          <a-row :gutter="24">
            ...
            <a-col :md="6" :sm="12" >
                <a-button type="primary"  style="left: 10px" @click="handleSearch" icon="search">{{$t('查询')}}</a-button>
                <a-button type="primary"  @click="handleReset" icon="reload" style="margin-left: 8px;left: 10px">{{$t('重置')}}</a-button>
            </a-col>
          </span>
          </a-row>
        </a-form>
