<template>
  <a-card :bordered="false">
    ...
    <a-button @click="onSearchProcess(searchProcessKey)" type="primary">{{$t('查询')}}</a-button>
    <a-button @click="onSearchProcess('')">{{$t('重置')}}</a-button>
    ...
    <!--流程表单-->
    <j-modal :destroyOnClose="true" :title="lcModa.title" v-model="lcModa.visible" :footer="null" :maskClosable="false" width="80%">
