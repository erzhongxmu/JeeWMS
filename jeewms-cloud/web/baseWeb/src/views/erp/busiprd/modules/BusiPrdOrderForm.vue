  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      ...
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
           <a-col :span="8" >
            <a-form-model-item :label="$t('采购日期')" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="query03">
              <j-date
              :showTime="true"
          ...
          <!-- <a-col :span="8" >
            <a-form-model-item :label="$t('建单日期')" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="query03">
              <a-input v-model="model.query03" :placeholder="$t('请输入建单日期')" ></a-input>
            </a-form-model-item>
          </a-col> -->
          <!-- <a-col :span="8" >
          ...
          <!-- <a-col :span="8" >
            <a-form-model-item :label="$t('公司')" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="query05">
              <a-input v-model="model.query05" :placeholder="$t('请输入公司')" ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="8" >
            <a-form-model-item :label="$t('工厂')" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="query06">
              <a-input v-model="model.query06" :placeholder="$t('请输入工厂')" ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="8" >
            <a-form-model-item :label="$t('库存地点')" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="query07">
              <a-input v-model="model.query07" :placeholder="$t('请输入库存地点')" ></a-input>
            </a-form-model-item>
          </a-col> -->
          <!-- <a-col :span="8" >
          ...
          <!-- <a-col :span="8" >
            <a-form-model-item :label="$t('单据附件')" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="attr1">
              <a-input v-model="model.attr1" :placeholder="$t('请输入单据附件')" ></a-input>
            </a-form-model-item>
          </a-col> -->
        </a-row>
      </a-form-model>
    ...
    <a-tabs v-model="activeKey" @change="handleChangeTabs">
      <a-tab-pane tab="商品信息" :key="refKeys[0]" :forceRender="true">
        <j-editable-table
          :ref="refKeys[0]"
          :loading="busiPrdOrderItemTable.loading"
          :columns="busiPrdOrderItemTable.columns"
          :dataSource="busiPrdOrderItemTable.dataSource"
          :maxHeight="300"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      closedata(){
        this.model = {};
        this.busiPrdOrderItemTable.dataSource = [];
        this.query21 = [];
      },
      addBefore(){
      ...
      editAfter() {
        ...
        if (this.model.id) {
          ...
          this.requestSubTableData(this.url.busiPrdOrdItem.list, params, this.busiPrdOrderItemTable)
