<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('base_craft')">导出</a-button>
    ...
    <base-craft-modal ref="modalForm" @ok="modalFormOk"></base-craft-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaseCraftModal from './modules/BaseCraftModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/jeeerp/baseCraft/list",
          delete: "/jeeerp/baseCraft/delete",
          deleteBatch: "/jeeerp/baseCraft/deleteBatch",
          exportXlsUrl: "/jeeerp/baseCraft/exportXls",
          importExcelUrl: "jeeerp/baseCraft/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'query06',text:'工艺编码'})
        fieldList.push({type:'string',value:'query07',text:'工艺名称'})
