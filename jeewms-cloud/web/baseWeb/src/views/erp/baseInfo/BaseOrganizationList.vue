<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('base_organization')">导出</a-button>
    ...
    <base-organization-modal ref="modalForm" @ok="modalFormOk"></base-organization-modal>
  </a-card>
</template>
...
<script>
  ...
  import BaseOrganizationModal from './modules/BaseOrganizationModal'
  ...
  export default {
    ...
    data () {
      return {
        description: 'base_organization管理页面',
        // 表头
        columns: [
          // {
          //   title: '#',
        ...
        url: {
          list: "/jeeerp/baseOrganization/list",
          delete: "/jeeerp/baseOrganization/delete",
          deleteBatch: "/jeeerp/baseOrganization/deleteBatch",
          exportXlsUrl: "/jeeerp/baseOrganization/exportXls",
          importExcelUrl: "jeeerp/baseOrganization/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'query04',text:'仓库'})
        fieldList.push({type:'string',value:'query05',text:'币种'})
        fieldList.push({type:'string',value:'query06',text:'query06'})
        fieldList.push({type:'string',value:'query07',text:'query07'})
        fieldList.push({type:'string',value:'query08',text:'query08'})
        fieldList.push({type:'string',value:'query09',text:'query09'})
        fieldList.push({type:'string',value:'query10',text:'query10'})
