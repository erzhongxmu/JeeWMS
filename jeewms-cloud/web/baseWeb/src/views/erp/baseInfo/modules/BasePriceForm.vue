    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="8">
            <!-- 类型（采购/销售/税率/成本价） -->
            <a-form-model-item label="类型" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="query06">
              <!-- <a-input v-model="model.query06" placeholder="请输入类型"  ></a-input>  -->
              <j-dict-select-tag
                type="list"
          ...
          <a-col :span="8">
            <!-- 来源编码（客户/供应商） -->
            <a-form-model-item label="来源编码" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="query07">
              <a-input v-model="model.query07" placeholder="请输入来源编码"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="8">
            <!-- 来源名称（客户/供应商） -->
            <a-form-model-item label="来源名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="query08">
              <a-input v-model="model.query08" placeholder="请输入来源名称"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="8">
            <a-form-model-item label="币种" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="query09">
              <a-input v-model="model.query09" placeholder="请输入币种"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="8">
            <a-form-model-item label="单位数量" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="query10">
              <a-input v-model="model.query10" placeholder="请输入单位数量"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="8">
            <a-form-model-item label="价格" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="query11">
              <a-input v-model="model.query11" placeholder="请输入价格"  ></a-input>
            </a-form-model-item>
          </a-col>
          <!-- <a-col :span="8">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/jeeerp/basePrice/add",
          edit: "/jeeerp/basePrice/edit",
          queryById: "/jeeerp/basePrice/queryById"
        }
      }
    },
    computed: {
