<template>
  <a-card :bordered="false">
    ...
    <conf-erp-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
...
<script>
  ...
  import ConfErpModal from './modules/ConfErpModal'
