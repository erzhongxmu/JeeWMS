<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <!-- <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item :label="$t('金额')">
              <a-input :placeholder="$t('请输入金额')" v-model="queryParam.query09"></a-input>
            </a-form-item>
          </a-col> -->
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd2" type="primary" icon="plus" v-has="'BusiOmPlan:add'" >{{$t('创建收款计划')}}</a-button>
      <!-- <a-button @click="handleAdd" type="primary" icon="plus" v-has="'BusiOmPlan:add'" >新增</a-button> -->
      <a-button type="primary" icon="download" @click="handleExportXls('收款计划')" v-has="'BusiOmPlan:export'" >{{$t('导出')}}</a-button>
    ...
    <addBusiOmPlanselect ref="addBusiOmPlanselect" @ok="modalFormOk" />
  </a-card>
</template>
...
import addBusiOmPlanselect from './modules/addBusiOmPlanselect'
  ...
  export default {
    ...
    methods: {
      handleAdd2(){
        this.$refs.addBusiOmPlanselect.add()
      },
      searchReset() {
        this.queryParam = {query01: "XSSKJH"}
        this.loadData()
      },
