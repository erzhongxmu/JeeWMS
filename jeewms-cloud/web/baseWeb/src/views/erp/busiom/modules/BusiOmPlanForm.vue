        ...
        <a-row>
          ...
          <a-col :span="8">
            <a-form-model-item :label="$t('计划收款金额')" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="num13">
              <a-input v-model="model.num02" :placeholder="$t('请输入计划收款金额')" ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="8"  v-if="model.query25 == '是'">
            <a-form-model-item :label="$t('计划收款含税金额')" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="num13">
              <a-input v-model="model.num03" :placeholder="$t('请输入计划收款含税金额')" ></a-input>
            </a-form-model-item>
          </a-col> -->
          <a-col :span="8">
  ...
  export default {
    ...
    valueChange(e){
      ...
      if(e.row.num01 && e.row.num04){
        this.getAllTable().then(tables => {
          // // 税率
          // let num10 = that.model.num10?this.model.num10/100:''
          // // 含税单价
