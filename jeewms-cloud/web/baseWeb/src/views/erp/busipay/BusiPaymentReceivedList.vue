<template>
  <a-card :bordered="false">
    ...
    <busi-payment-received-modal ref="modalForm" @ok="modalFormOk"></busi-payment-received-modal>
  </a-card>
</template>
...
<script>
  ...
  import BusiPaymentReceivedModal from './modules/BusiPaymentReceivedModal'

  export default {
    name: 'BusiPaymentReceivedList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      BusiPaymentReceivedModal
    },
    data () {
      return {
        description: 'busi_payment_received管理页面',
        // 表头
        columns: [
          {
            title:'创建人名称',
