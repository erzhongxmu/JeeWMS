<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd2" type="primary" icon="plus" v-has="'BusiOmPlan:add'" >{{$t('收款')}}</a-button>
    ...
    <busi-received-modal ref="modalForm" @ok="modalFormOk" />
    <addBusiReceivedselect ref="addBusiReceivedselect" @ok="modalFormOk" />
  </a-card>
</template>
...
import BusiReceivedModal from './modules/BusiReceivedModal'
import addBusiReceivedselect from './modules/addBusiReceivedselect'
...
export default {
  ...
  methods: {
    ...
    handleAdd2(){
      this.$refs.addBusiReceivedselect.add()
    },
