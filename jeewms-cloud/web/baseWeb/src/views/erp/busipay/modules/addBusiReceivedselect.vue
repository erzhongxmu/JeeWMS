<template>
    <j-modal :title="title" :width="width" :visible="visible" switchFullscreen @ok="handleOk" @cancel="close"
        ...
        <j-modal :title="$t('确认收款数据')" :width="800" :visible="visible2" switchFullscreen @ok="handleOk2" @cancel="close2"
...
export default {
    ...
    methods: {
        ...
        loadData() {
            ...
            getAction("/jeeerp/vOmsRevWq/list", obj).then(res => {
                if (res.success) {
        ...
        handleOk() {
            ...
            getAction("/jeeerp/vOmsRevWq/list2", obj).then(res => {
                if (res.success) {
