<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('busi_in_or_out')">导出</a-button>
    ...
    <busi-in-or-out-modal ref="modalForm" @ok="modalFormOk"></busi-in-or-out-modal>
  </a-card>
</template>
...
<script>
  ...
  import BusiInOrOutModal from './modules/BusiInOrOutModal'

  export default {
    name: 'BusiInOrOutList',
    ...
    data () {
      return {
        description: 'busi_in_or_out管理页面',
        // 表头
        columns: [
          {
            title:'创建人名称',
        ...
        url: {
          list: "/jeeerp/busiInOrOut/list",
          delete: "/jeeerp/busiInOrOut/delete",
          deleteBatch: "/jeeerp/busiInOrOut/deleteBatch",
          exportXlsUrl: "/jeeerp/busiInOrOut/exportXls",
          importExcelUrl: "jeeerp/busiInOrOut/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'query15',text:'检验类型'})
