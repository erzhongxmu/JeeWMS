<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('单表示例')">{{$t('导出')}}</a-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        //字典数组缓存
        sexDictOptions: [],
        importExcelUrl:`${window._CONFIG['domianURL']}/test/baseDemo/importExcel`,
        //表头
        columns:[],
        //列设置
        settingColumns:[],
        ...
        url: {
          list: "/test/baseDemo/list",
          delete: "/test/baseDemo/delete",
          deleteBatch: "/test/baseDemo/deleteBatch",
          exportXlsUrl: "/test/baseDemo/exportXls"
        },
