        ...
        <a-row>
          ...
          <a-col :span="14">
            <a-form v-if="barType === 'month' && false" layout="inline" style="margin-top: -4px">
              ...
              <a-button style="margin-top: 2px" type="primary" icon="search" @click="queryDatebar">{{$t('查询')}}</a-button>
              <a-button style="margin-top: 2px;margin-left: 8px" type="primary" icon="reload" @click="searchReset">{{$t('重置')}}</a-button>
            </a-form>
          </a-col>
          ...
          <a-col :span="14">
            <a-form v-if="pieType === 'month' && false" layout="inline" style="margin-top: -4px">
              <a-row :gutter="24">
                ...
                <a-button style="margin-top: 2px" type="primary" icon="search" @click="queryDatepie">{{$t('查询')}}</a-button>
                <a-button style="margin-top: 2px;margin-left: 8px" type="primary" icon="reload" @click="searchReset">{{$t('重置')}}</a-button>
              </a-row>
            </a-form>
          </a-col>
