      ...
      <a-form :form="form">
        ...
        <a-tabs defaultActiveKey="1" >
          <a-tab-pane tab="Tab 1" key="1">
            ...
            <a-table   class="j-table-force-nowrap"  :columns="columns" :dataSource="data" :pagination="false" size="middle">
              ...
              <template slot="operation" slot-scope="text, record, index">
                <template v-if="record.editable">
                  <span v-if="record.isNew">
                    ...
                    <a-popconfirm title="是否要删除此行？" @confirm="removeRow(record.key)"><a>{{$t('删除')}}</a></a-popconfirm>
                  </span>
                  <span v-else>
                ...
                <span v-else>
                  <a @click="editRow(record.key)">{{$t('编辑')}}</a>
                  <a-divider type="vertical"/>
                  <a-popconfirm title="是否要删除此行？" @confirm="removeRow(record.key)"><a>{{$t('删除')}}</a></a-popconfirm>
                </span>
              </template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        validatorRules: {},
        url: {
          add: "/test/baseDemo/add",
          edit: "/test/baseDemo/edit",
        },
      }
    },
    created() {
