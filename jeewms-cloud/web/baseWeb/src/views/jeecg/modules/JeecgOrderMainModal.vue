          ...
          <a-tab-pane tab="货主信息" key="1">
            <div>
              ...
              <a-row type="flex" style="margin-bottom:10px" :gutter="16" v-for="(item, index) in orderMainModel.jeecgOrderCustomerList" :key="index">
                ...
                <a-col :span="5">
                  <a-form-item>
                    <a-input placeholder="货主名" v-decorator="['jeecgOrderCustomerList['+index+'].name', {'initialValue':item.name,rules: [{ required: true, message: '请输入用户名!' }]}]" />
                  </a-form-item>
                </a-col>
                <a-col :span="5">
                  <a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/test/baseOrderMain/add",
          edit: "/test/baseOrderMain/edit",
          orderCustomerList: "/test/baseOrderMain/queryOrderCustomerListByMainId",
          orderTicketList: "/test/baseOrderMain/queryOrderTicketListByMainId",
        },
      }
    },
    created () {
