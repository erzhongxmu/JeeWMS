package com.huayi.sapdataex.service;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.huayi.sapdataex.controller.wmientity;
...
public class dataexchangeImpl {
    ...
    public JSONObject exData(@RequestBody JSONObject jsonObject, HttpServletResponse response, HttpServletRequest request) {
        ...
        try {
            ...
            //rfc 输入参数
            try{
                HashMap<String, Object> rfcInpara = (HashMap<String, Object>) jsonObject.get("rfcInPara");
            ...
            //rfc 输出表
            try{
                HashMap<String, Object> rfcOutTable = (HashMap<String, Object>) jsonObject.get("rfcOutTable");
