<template>
	<view class="zai-box">
		...
		<!-- 扫描二维码弹窗 -->
		<!-- <view class="cu-modal" :class="modalName=='ewmModal'?'show':''">
			<view class="cu-dialog">
				<view class="cu-bar bg-white justify-end">
					<view class="content">扫描工牌二维码</view>
					<view class="action" @tap="hideModal">
						<text type="password" class="cuIcon-close text-red"></text>
					</view>
				</view>
				<view class="padding-xl">
					<view class="cu-form-group">
						<input type="password" v-model="gpEwm" :focus="ewmFocus" placeholder="" name="input" @confirm="handleEwmModal"></input>
					</view>
				</view>
				<view class="cu-bar bg-white justify-end">
					<view class="action">
						<button class="cu-btn line-blue text-blue" @tap="hideModal">取消</button>
						<button class="cu-btn bg-blue margin-left" @tap="handleEwmModal">确定</button>
