<template>
	<view class="content">
		...
		<view class="Search" style="flex-direction: column;height: 	107rpx;">
			<input type="text" v-model="query02" :focus="isFocus1" @confirm="getDetails(1)" :placeholder="$t('pages.PleaseScanTheTrayNumber')"/>
		</view>
