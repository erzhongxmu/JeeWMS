<template>
	<view class="content">
		...
		<view class="Search" style="flex-direction: column;">
			<input type="text" v-model="query01" :focus="isFocus1"  @confirm="getDetails(1)"  :placeholder="$t('pages.PleaseScanTheStorageInformation')"  />
...
<!-- 				<view class="item">
					<view>仓库{{$t('pages.WaveNumber')}}：</view>
