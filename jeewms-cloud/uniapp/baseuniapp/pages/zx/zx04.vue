		...
		<scroll-view scroll-y="true" style="flex: 1;overflow: auto;" @scrolltolower='scroll'>
			<view class="body_t" v-for="(item,index) in data" :key=	'index'>
				...
				<view class="item">
					...
					<view style="color: #3297E2;">{{item.query08}}</view>
				</view>
				<!-- <view class="inputText">
					<view class="" style="display: flex; width: 100%; align-items: center;justify-content: space-between;">
						...
						<view class="select-input" >
							...
							<picker class="search-picker" @change="(e)=>{bindPickerChange(e,index,'query09',item.list01)}"  :range="item.list01" range-key="query01">
				...
				<view class="inputText">
					<view class="" style="display: flex; width: 100%; align-items: center;justify-content: space-between;">
						<text>{{$t('pages.OutboundStoring')}}：</text>
						...
						<!-- <view class="select-input" >
							<input v-model="item.query10" style=" color: #3297E2;text-align: right;padding-right: 20rpx;margin-top: 0;"   placeholder-style="color:#E0E2E4"/>
							<picker class="search-picker" @change="(e)=>{bindPickerChange(e,index,'query10',item.list02)}"  :range="item.list02" range-key="query01">
								<image style="width: 13px; height: 7px;" src="@/static/icon/jiantou.png" mode=""></image>
							</picker>
						</view> -->
					</view>
