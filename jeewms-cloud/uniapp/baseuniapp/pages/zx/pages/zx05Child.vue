<template>
	<view class="content">
		...
		<scroll-view scroll-y="true" style="flex: 1;overflow: auto;" @scrolltolower='scroll'>
			<view class="body_t" v-for="(item,index) in data" :key=	'index' v-if="Number(item.query03) > 0 ">
				<view class="item">
				...
				<view class="inputText" >
					<view class="" style="display: flex; width: 100%; align-items: center;justify-content: space-between;border">
						...
						<input v-model="item.query05" style=" color: #3297E2;text-align: right;padding-right: 20rpx;width: 300rpx;margin-top: 0;" type="text"   placeholder-style="color:#E0E2E4"/>
					</view>
				</view>
				<view class="inputText" >
					<view class="" style="display: flex; width: 100%; align-items: center;justify-content: space-between;border">
						<text>{{$t('pages.NumberOfGroupsSupporting')}}：</text>
						<input v-model="item.query06" style=" color: #3297E2;text-align: right;padding-right: 20rpx;width: 300rpx;margin-top: 0;" type="number"   placeholder-style="color:#E0E2E4"/>
					</view>
				</view>
				<!--< view class="inputText">
