...
import com.base.handler.HystrixFallbackHandler;
...
public class GatewayRoutersConfiguration {
    ...
    @Value("${base.route.config.data-id:#{null}}")
    public void setRouteDataId(String dataId) {
        DATA_ID = dataId + ".json";
    }

    @Value("${base.route.config.group:DEFAULT_GROUP:#{null}}")
    public void setRouteGroup(String routeGroup) {
        ROUTE_GROUP = routeGroup;
    }

    @Value("${base.route.config.data-type}")
