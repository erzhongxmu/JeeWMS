...
@ApiModel(value="bms_payment对象", description="bms_payment")
public class BmsPayment implements Serializable {
...
//   //	@ApiModelProperty(value = "备用1")
    ...
    @Excel(name = "付款编号", width = 15)
    @ApiModelProperty(value = "付款编号")
    private java.lang.String paymetNo;
    /**付款方式*/
    @Excel(name = "付款方式", width = 15)
    @ApiModelProperty(value = "付款方式")
    private java.lang.String paymetType;
    /**发票号*/
    ...
    private java.math.BigDecimal paymetSum;
    /**发票金额*/
