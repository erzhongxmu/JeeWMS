...
@ApiModel(value="base_price对象", description="base_price")
public class BasePrice implements Serializable {
	...
	/**来源编码（客户/供应商）*/
	@Excel(name = "来源编码（客户/供应商）", width = 15)
    @ApiModelProperty(value = "来源编码（客户/供应商）")
    private java.lang.String query07;
	/**来源名称（客户/供应商）*/
	@Excel(name = "来源名称（客户/供应商）", width = 15)
    @ApiModelProperty(value = "来源名称（客户/供应商）")
