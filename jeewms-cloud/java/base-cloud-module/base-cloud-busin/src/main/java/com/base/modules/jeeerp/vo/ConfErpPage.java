 ...
 */
@Data
@ApiModel(value="conf_erpPage对象", description="conf_erp")
public class ConfErpPage {
	...
	@ExcelCollection(name="conf_erp_item")
	@ApiModelProperty(value = "conf_erp_item")
	private List<ConfErpItem> confErpItemList;
