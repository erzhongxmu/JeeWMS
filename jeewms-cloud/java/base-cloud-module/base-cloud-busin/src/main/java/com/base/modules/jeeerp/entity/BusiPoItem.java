 ...
 * @Version: V1.0
 */
@ApiModel(value="busi_po_item对象", description="busi_po_item")
@Data
@TableName("busi_po_item")
public class BusiPoItem implements Serializable {
    ...
    @Excel(name = "query37", width = 15)
    @ApiModelProperty(value = "query37")
    ...
    @JsonSerialize(using = CustomDoubleSerializer2.class)
