 ...
 */
@Data
@ApiModel(value="busi_omPage对象", description="busi_om")
public class BusiOmPage {
	...
	@ExcelCollection(name="busi_om_item")
	@ApiModelProperty(value = "busi_om_item")
	private List<BusiOmItem> busiOmItemList;
