 ...
 */
@Data
@TableName("wm_his_stock_data")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="wm_his_stock_data对象", description="wm_his_stock_data")
public class WmHisStockData implements Serializable {
	...
	/**proData*/
	@Excel(name = "proData", width = 15)
    @ApiModelProperty(value = "proData")
