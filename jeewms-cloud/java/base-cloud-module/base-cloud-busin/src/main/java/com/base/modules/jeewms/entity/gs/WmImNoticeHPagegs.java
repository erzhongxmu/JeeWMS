...
public class WmImNoticeHPagegs {
	...
	@Excel(name = "货主名称", width = 15     ,orderNum = "5")
...
//	@Excel(name = "订单类型", width = 15,dicCode = "im_order_type"      ,orderNum = "3")
	...
	/**备注*/
	@Excel(name = "备注", width = 15      ,orderNum = "2")
...
//	@Excel(name = "仓库名称", width = 15)
	...
	@Excel(name = "ERP单号", width = 15     ,orderNum = "0")
	...
	private List<WmImNoticeIgs> wmImNoticeIList;
