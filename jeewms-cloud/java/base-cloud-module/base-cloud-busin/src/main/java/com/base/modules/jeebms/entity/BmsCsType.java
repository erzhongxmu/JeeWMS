 ...
 */
@Data
@TableName("bms_cs_type")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="bms_cs_type对象", description="bms_cs_type")
public class BmsCsType implements Serializable {
...
//   //	@ApiModelProperty(value = "备用1")
    ...
    /**来源SQL*/
//	@Excel(name = "来源SQL", width = 15)
    @ApiModelProperty(value = "来源SQL")
    private java.lang.String costSSql;
    /**来源API*/
//	@Excel(name = "来源API", width = 15)
    @ApiModelProperty(value = "来源API")
    private java.lang.String costSApi;
}
