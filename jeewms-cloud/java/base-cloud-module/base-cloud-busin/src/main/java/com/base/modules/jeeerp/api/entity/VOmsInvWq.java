 ...
 */
@Data
@TableName("v_oms_inv_wq")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="v_oms_inv_wq对象", description="v_oms_inv_wq")
public class VOmsInvWq implements Serializable {
