 ...
 */
@Data
@TableName("base_goods_item")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="base_goods_item对象", description="base_goods_item")
public class BaseGoodsItem implements Serializable {
	...
	/**销售运输方式*/
	@Excel(name = "销售运输方式", width = 15)
    @ApiModelProperty(value = "销售运输方式")
	...
	/**生产周期*/
	@Excel(name = "生产周期", width = 15)
    @ApiModelProperty(value = "生产周期")
    private java.lang.String query08;
	/**质检方式*/
	@Excel(name = "质检方式", width = 15)
    @ApiModelProperty(value = "质检方式")
    private java.lang.String query09;
	/**质检比例*/
	@Excel(name = "质检比例", width = 15)
    @ApiModelProperty(value = "质检比例")
