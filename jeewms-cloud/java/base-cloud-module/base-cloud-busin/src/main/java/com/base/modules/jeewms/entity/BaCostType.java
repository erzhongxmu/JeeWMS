 ...
 */
@Data
@TableName("ba_cost_type")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="ba_cost_type对象", description="费用类型")
public class BaCostType implements Serializable {
    ...
    private java.lang.String costTypeDel;
}
