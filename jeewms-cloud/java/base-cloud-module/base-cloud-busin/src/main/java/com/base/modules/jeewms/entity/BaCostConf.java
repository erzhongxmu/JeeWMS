 ...
 */
@Data
@TableName("ba_cost_conf")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="ba_cost_conf对象", description="费用模板")
public class BaCostConf implements Serializable {
	...
	/**费用名称*/
	@Excel(name = "费用名称", width = 15, dictTable = "ba_cost", dicText = "cost_name", dicCode = "cost_code")
	@Dict(dictTable = "ba_cost", dicText = "cost_name", dicCode = "cost_code")
