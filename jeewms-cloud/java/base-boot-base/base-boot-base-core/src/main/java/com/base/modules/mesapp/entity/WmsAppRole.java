 ...
 */
@Data
@TableName("wms_app_role")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="wms_app_role对象", description="主数据—APP角色")
public class WmsAppRole implements Serializable {
    ...
    private java.lang.String appmodelId;
	/**app模块编号*/
