...
@Slf4j
@Component
public class BaseElasticsearchTemplate {
    /** es服务地址 */
    ...
    public BaseElasticsearchTemplate(@Value("${base.elasticsearch.cluster-nodes}") String baseUrl, @Value("${base.elasticsearch.check-enabled}") boolean checkEnabled) {
        log.debug("BaseElasticsearchTemplate BaseURL：" + baseUrl);
