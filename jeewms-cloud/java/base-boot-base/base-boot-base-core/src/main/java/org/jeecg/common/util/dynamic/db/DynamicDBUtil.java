...
import com.base.common.util.ReflectHelper;
import com.base.common.util.dynamic.db.DataSourceCachePool;
import com.base.common.util.dynamic.db.FreemarkerParseFactory;
    ...
    public static DruidDataSource getDbSourceByDbKey(final String dbKey) {
        ...
        if (cacheDbSource != null && !cacheDbSource.isClosed()) {
            ...
            if(dataSource!=null && dataSource.isEnable()){
                ...
                throw new BaseBootException("动态数据源连接失败，dbKey："+dbKey);
            }
