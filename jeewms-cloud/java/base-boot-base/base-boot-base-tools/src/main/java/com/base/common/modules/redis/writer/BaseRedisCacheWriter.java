package com.base.common.modules.redis.writer;
...
public class BaseRedisCacheWriter implements RedisCacheWriter {
    ...
    public BaseRedisCacheWriter(RedisConnectionFactory connectionFactory) {
        this(connectionFactory, Duration.ZERO);
    }

    public BaseRedisCacheWriter(RedisConnectionFactory connectionFactory, Duration sleepTime) {
