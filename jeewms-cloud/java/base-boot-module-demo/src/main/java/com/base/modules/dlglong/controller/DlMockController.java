package com.base.modules.dlglong.controller;
...
import com.base.common.constant.VXESocketConst;
import com.base.common.system.query.MatchTypeEnum;
import com.base.common.system.query.QueryCondition;
import com.base.modules.demo.mock.vxe.websocket.VXESocket;
import com.base.modules.dlglong.entity.MockEntity;
...
public class DlMockController {
    ...
    public Result getMockData(
        ...
        // 模拟JSON数据路径
        String path = "classpath:com/base/modules/dlglong/json/dlglong.json";
        // 读取JSON数据
    ...
    public Result getMockDdjhData(
        ...
        // 模拟JSON数据路径
        String path = "classpath:com/base/modules/dlglong/json/ddjh.json";
        if ("8".equals(status)) {
            path = "classpath:com/base/modules/dlglong/json/ddjh_s8.json";
        }
        // 读取JSON数据
        JSONArray dataList = readJsonData(path);
        if (dataList == null) {
        ...
        for (JSONObject record : records) {
            Map<String, Integer> tugStatusMap = new HashMap<>(1024);
