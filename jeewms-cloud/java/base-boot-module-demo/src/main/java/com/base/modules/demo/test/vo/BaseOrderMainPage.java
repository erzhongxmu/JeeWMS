package com.base.modules.demo.test.vo;
...
@Data
public class BaseOrderMainPage {
	...
	private List<BaseOrderCustomer> baseOrderCustomerList;
	@ExcelCollection(name="机票")
	private List<BaseOrderTicket> baseOrderTicketList;
