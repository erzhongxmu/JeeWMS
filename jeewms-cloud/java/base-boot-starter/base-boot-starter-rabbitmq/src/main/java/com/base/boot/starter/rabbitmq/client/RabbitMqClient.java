package com.base.boot.starter.rabbitmq.client;


import cn.hutool.core.util.ObjectUtil;
import com.base.boot.starter.rabbitmq.exchange.DelayExchangeBuilder;
import lombok.extern.slf4j.Slf4j;
import com.base.boot.starter.rabbitmq.event.EventObj;
...
public class RabbitMqClient {
    ...
    public void publishEvent(String handlerName, BaseMap baseMap) {
        ...
        publisher.publishEvent(new BaseRemoteApplicationEvent(eventObj, busProperties.getId()));
    }
