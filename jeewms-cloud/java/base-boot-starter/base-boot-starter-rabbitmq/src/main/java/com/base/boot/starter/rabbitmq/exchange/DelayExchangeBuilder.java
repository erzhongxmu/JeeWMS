package com.base.boot.starter.rabbitmq.exchange;
...
public class DelayExchangeBuilder {
     ...
     * 默认延迟消息交换器
     */
    public final static  String DEFAULT_DELAY_EXCHANGE = "base.delayed.exchange";
    /**
     * 普通交换器
     */
    public final static  String DELAY_EXCHANGE = "base.direct.exchange";
