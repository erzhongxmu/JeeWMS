package com.base.boot.starter.job.config;

import com.base.boot.starter.job.prop.XxlJobProperties;
...
@ConditionalOnProperty(value = "base.xxljob.enabled", havingValue = "true", matchIfMissing = true)
