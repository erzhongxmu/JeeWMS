...
import com.base.common.api.dto.OnlineAuthDTO;
import com.base.common.api.dto.message.*;
import com.base.common.aspect.UrlMatchEnum;
import com.base.common.constant.CacheConstant;
import com.base.common.constant.DataBaseConstant;
import com.base.common.constant.WebsocketConst;
import com.base.common.exception.BaseBootException;
import com.base.common.system.vo.ComboModel;
import com.base.common.system.vo.LoginUser;
import com.base.common.system.vo.SysUserCacheInfo;
import com.base.common.util.SysAnnmentTypeEnum;
import com.base.common.util.YouBianCodeUtil;
import com.base.common.util.oConvertUtils;
import com.base.modules.message.entity.SysMessageTemplate;
import com.base.modules.message.handle.impl.EmailSendMsgHandle;
import com.base.modules.message.service.ISysMessageTemplateService;
import com.base.modules.message.websocket.WebSocket;
import com.base.modules.system.entity.*;
import com.base.modules.system.mapper.*;
import com.base.modules.system.service.*;
import com.base.modules.system.service.impl.ThirdAppDingtalkServiceImpl;
import com.base.modules.system.service.impl.ThirdAppWechatEnterpriseServiceImpl;
import com.base.modules.system.util.SecurityUtil;
...
public class SysBaseApiImpl implements ISysBaseAPI {
    ...
    public void sendTemplateAnnouncement(TemplateMessageDTO message) {
        ...
        if (sysSmsTemplates == null || sysSmsTemplates.size() == 0) {
            throw new BaseBootException("消息模板不存在，模板编码：" + templateCode);
        }
        ...
        if ("".equals(DB_TYPE)) {
            ...
            try {
                ...
                if (dbType.indexOf("mysql") >= 0) {
                    ...
                    //throw new BaseBootException("数据库类型:["+dbType+"]不识别!");
                }
            } catch (Exception e) {
    ...
    @Override
    public List<com.base.common.system.vo.SysDepartModel> getAllSysDepart() {
        List<com.base.common.system.vo.SysDepartModel> departModelList = new ArrayList<com.base.common.system.vo.SysDepartModel>();
        List<SysDepart> departList = departMapper.selectList(new QueryWrapper<SysDepart>().eq("del_flag", "0"));
        for (SysDepart depart : departList) {
            com.base.common.system.vo.SysDepartModel model = new com.base.common.system.vo.SysDepartModel();
    ...
    @Override
    public com.base.common.system.vo.SysDepartModel selectAllById(String id) {
        SysDepart sysDepart = sysDepartService.getById(id);
        com.base.common.system.vo.SysDepartModel sysDepartModel = new com.base.common.system.vo.SysDepartModel();
