package com.base.modules.quartz.service.impl;

import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.base.common.exception.BaseBootException;
import com.base.common.util.DateUtils;
import com.base.modules.quartz.entity.QuartzJob;
import com.base.modules.quartz.mapper.QuartzJobMapper;
import com.base.modules.quartz.service.IQuartzJobService;
...
public class QuartzJobServiceImpl extends ServiceImpl<QuartzJobMapper, QuartzJob> implements IQuartzJobService {
	 ...
	 */
	@Override
	@Transactional(rollbackFor = BaseBootException.class)
	...
	private void schedulerAdd(String id, String jobClassName, String cronExpression, String parameter) {
		try {
			...
			throw new BaseBootException("创建定时任务失败", e);
		} catch (RuntimeException e) {
			throw new BaseBootException(e.getMessage(), e);
		}catch (Exception e) {
			throw new BaseBootException("后台找不到该类名：" + jobClassName, e);
		}
	}
	...
	private void schedulerDelete(String id) {
		try {
			...
			throw new BaseBootException("删除定时任务失败");
		}
	}
