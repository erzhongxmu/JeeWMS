package com.base.modules.message.job;

import java.util.List;

import com.base.common.util.DateUtils;
import com.base.modules.message.entity.SysMessage;
import com.base.modules.message.handle.ISendMsgHandle;
import com.base.modules.message.handle.enums.SendMsgStatusEnum;
import com.base.modules.message.handle.enums.SendMsgTypeEnum;
...
public class SendMsgJob implements Job {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		log.info(String.format(" base-Boot 发送消息任务 SendMsgJob !  时间:" + DateUtils.getTimestamp()));
