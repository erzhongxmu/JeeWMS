...
import com.base.modules.system.mapper.SysCategoryMapper;
import com.base.modules.system.service.ISysCategoryService;
...
public class SysCategoryServiceImpl extends ServiceImpl<SysCategoryMapper, SysCategory> implements ISysCategoryService {
	...
	public List<TreeSelectModel> queryListByCode(String pcode) throws BaseBootException {
		...
		if(oConvertUtils.isNotEmpty(pcode)) {
			...
			if(list.size()>1) {
				throw new BaseBootException("该编码【"+pcode+"】存在多个，请核实!");
			}
