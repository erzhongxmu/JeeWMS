package com.base.modules.ngalain.service.impl;
...
import com.base.modules.system.mapper.SysDictMapper;
...
public class NgAlainServiceImpl implements NgAlainService {
    ...
    public JSONArray getBaseMenu(String id) throws Exception {
        ...
        JSONObject baseMenu = new JSONObject();
        baseMenu.put("text", "base菜单");
        baseMenu.put("group",true);
        baseMenu.put("children", menulist);
        JSONArray  baseMenuList=new JSONArray();
