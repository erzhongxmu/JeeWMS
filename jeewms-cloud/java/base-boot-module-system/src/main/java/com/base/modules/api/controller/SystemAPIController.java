...
public class SystemAPIController {
    ...
    public com.base.common.system.vo.SysDepartModel selectAllById(@RequestParam("id") String id){
    ...
    public com.base.common.system.vo.SysUserCacheInfo getCacheUser(@RequestParam("username") String username){
