...
//            series.add(seriesBean2);
            ...
            try {
                for (FxjoutputEntity f : list) {
                    com.base.modules.bidata.bientity.bgEntity.DataBean bean = new com.base.modules.bidata.bientity.bgEntity.DataBean();
                    bean.setType1(f.getFxjx1());
                    bean.setType2(f.getFxjx2());
                    if(StringUtil.isNotEmpty(f.getFxjx3())){
                        bean.setType3(f.getFxjx3());
                    }
                    if(StringUtil.isNotEmpty(f.getFxjx4())){
                        bean.setType4(f.getFxjx4());
                    }
                    if(StringUtil.isNotEmpty(f.getFxjx5())){
                        bean.setType5(f.getFxjx5());
                    }
                    ll.add(bean);
                }
            } catch (Exception e) {
            ...
            dataBean.setLabel(list.get(0).getFxjx3());
            dataBean.setData(list.get(0).getFxjx2());
            dataBean.setValue(list.get(0).getFxjx1());
            return new ResponseEntity(dataBean, HttpStatus.OK);
