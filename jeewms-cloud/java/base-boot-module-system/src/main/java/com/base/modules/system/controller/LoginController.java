...
import com.base.common.util.encryption.EncryptedString;
...
import com.base.modules.system.model.SysLoginModel;
import com.base.modules.system.service.*;
import com.base.modules.system.util.RandImageUtil;
...
//		redisUtil.del(realKey);
	...
	private Result<JSONObject> userInfo(SysUser sysUser, Result<JSONObject> result) {
		...
		redisUtil.set(CacheConstant.SYS_USERS_CACHE_JWT + ":" + token,JSONObject.toJSONString(sysUser),JwtUtil.EXPIRE_TIME * 2 / 1000);
		obj.put("token", token);
		obj.put("userInfo", sysUser);
