...
<!--     <img src="plug-in/login/images/logo.jpg">  -->
    <!--
        ...
        <div style="position: absolute; top: 75px; left: 33px;"><t:mutiLang langKey="com.sysname"/> <span style="letter-spacing: -1px;"> </span></div>
    </td>
...
<!--         <div class="easyui-tab" title="效期预警" href="mvStockYjController.do?list" style="padding: 2px;"></div> -->
