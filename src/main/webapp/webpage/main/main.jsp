...
<!-- 顶部-->
<div region="north" border="false" title=<t:mutiLang langKey="com.sysname"/> style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr>
    <td align="left" style="vertical-align: text-bottom;">欢迎使用<t:mutiLang langKey="com.sysname"/></td>
...
<%--     <div class="easyui-tab" title="<t:mutiLang langKey="common.dash_board"/>" href="loginController.do?home" style="padding: 2px; overflow: hidden;"></div> --%>
 <div class="easyui-tab" title="效期预警" style="padding: 1px; overflow: hidden;">
                <iframe name="myMap" id="myMap" scrolling="no" frameborder="0" src="mvStockYjController.do?list" style="width: 100%; height: 99.5%;"></iframe>
            </div>
    </div>
</div>
<!-- 右侧 -->
