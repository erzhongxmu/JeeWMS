	...
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wmSttInGoodsController.do?doUpdate" tiptype="1" >
			...
			<div class="tab-wrapper">
			    ...
			    <ul class="nav nav-tabs">
			      <li role="presentation" class="active"><a href="javascript:void(0);">库存盘点</a></li>
			    </ul>
			    <!-- tab内容 -->
			      ...
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="goodsId" name="goodsId" type="text" class="form-control"
									ignore="ignore"
								   value='${wmSttInGoodsPage.goodsId}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="goodsName" name="goodsName" type="text" class="form-control"
									ignore="ignore"
								   value='${wmSttInGoodsPage.goodsName}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="goodsQua" name="goodsQua" type="text" class="form-control"
									ignore="ignore"
								   value='${wmSttInGoodsPage.goodsQua}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="goodsUnit" name="goodsUnit" type="text" class="form-control"
									ignore="ignore"
								   value='${wmSttInGoodsPage.goodsUnit}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="goodsBatch" name="goodsBatch" type="text" class="form-control"
									ignore="ignore"
								   value='${wmSttInGoodsPage.goodsBatch}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="sttQua" name="sttQua" type="text" class="form-control"
									ignore="ignore"
								   value='${wmSttInGoodsPage.sttQua}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="cusName" name="cusName" type="text" class="form-control"
									ignore="ignore"
								   value='${wmSttInGoodsPage.cusName}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="sttType" name="sttType" type="text" class="form-control"
									ignore="ignore"
								   value='${wmSttInGoodsPage.sttType}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
