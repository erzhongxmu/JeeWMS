...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wmDayCostList" autoLoadData="false" checkbox="true" pagination="true" fitColumns="false" title="收款明细表" actionUrl="wmDayCostController.do?datagridsk" idField="id" pageSize="500" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="wmDayCostController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
      ...
      <%--<t:dgToolBar title="批量结清"  icon="icon-remove"   funname="pljq"></t:dgToolBar>--%>
      <t:dgToolBar title="取消收款"  icon="icon-remove"   funname="plfjq"></t:dgToolBar>
