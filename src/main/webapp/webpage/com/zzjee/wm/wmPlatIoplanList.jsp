...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wmPlatIoList" checkbox="true" pagination="true" fitColumns="false" title="月台进出" actionUrl="wmPlatIoController.do?datagridplan" idField="id" fit="true" queryMode="group">
