...
// 	        $('#binIdTo').val($('#orderId').val());
     ...
     function getgoodstext(){
 		ajaxurl="wmToUpGoodsController.do?doGettextzy&goodsid="+$('#goodsId').val();
 		$.get(ajaxurl).done(function (data) {
 	        var obj = eval('(' + data + ')');;      
 	        console.log(obj);
 	        if(!obj.success){
 ...
 <body>
	...
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wmToUpGoodsController.do?doAdd" tiptype="1" >
			      ...
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="cusCode" name="cusCode" type="text" class="form-control" 
									ignore="ignore" onchange="getcustext()" datatype="*" 
								 />
