...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wmDayCostList" autoLoadData="false" checkbox="true" pagination="true" fitColumns="false" title="费用明细" actionUrl="wmDayCostController.do?datagrid" idField="id" pageSize="500" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="wmDayCostController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
      ...
      <t:dgToolBar title="收款取消"  icon="icon-remove"   funname="plfjq"></t:dgToolBar>
