...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wvDayCostSumList"  autoLoadData="false"  checkbox="true" pagination="true" fitColumns="false" title="按天合计费用（已收款）" actionUrl="wvDayCostSumController.do?datagridy" idField="id"  pageSize="500" fit="true" queryMode="group">
