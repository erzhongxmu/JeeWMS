...
public class MenuInitServiceImpl extends CommonServiceImpl implements
    ...
    public void initMenu() {
        ...
        Map<String, TSFunction> functionMap = new HashMap<String, TSFunction>(1024);//菜单map,key为菜单匹配规则的字符串
        Map<String, TSOperation> operationMap = new HashMap<String, TSOperation>(1024);//菜单操作按钮map,key为菜单操作按钮匹配规则的字符串
