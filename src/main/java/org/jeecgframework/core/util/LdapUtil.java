...
//	private static final String DOMAIN_NAME = "ARTGRI";
//	private static final String DOMAIN_SUFFIX = "com";
//
//	// 请注意这里并不能直接用EXAMPLE.COM当作LDAP SERVER来取代LDAP_SERVER_IP
//	private static final String LDAP_SERVER_IP = "192.168.254.26";
//	private static final String LDAP_PORTAL = "389";

	private static final String DOMAIN_NAME = ResourceUtil.getConfigByName("ldap.DOMAIN_NAME");
	private static final String DOMAIN_SUFFIX = ResourceUtil.getConfigByName("ldap.DOMAIN_SUFFIX");

	// 请注意这里并不能直接用EXAMPLE.COM当作LDAP SERVER来取代LDAP_SERVER_IP
	private static final String LDAP_SERVER_IP = ResourceUtil.getConfigByName("ldap.LDAP_SERVER_IP");
	private static final String LDAP_PORTAL = ResourceUtil.getConfigByName("ldap.LDAP_PORTAL");
	...
	public static void main(String[] args) throws Exception {
		...
		// get AD Context
		String adAdmin = "administrator";
		String adAdminPassword = "artgri@999";
		...
		String searchBase = "DC=artgri,DC=com";
		String returnedAtts[] = {
				"name", "userPrincipalName",
				"departmentNumber", "telephoneNumber", "homePhone",
				"mobile", "department", "sAMAccountName",
				"mail" };
