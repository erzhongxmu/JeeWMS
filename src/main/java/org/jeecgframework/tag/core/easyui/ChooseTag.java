...
public class ChooseTag extends TagSupport {
	...
	public StringBuffer end() {
		...
		if(isInit){
			sb.append("var initValue = ").append("$(\"input[name='" + hiddenName + "']\").val();");
			sb.append("var coscodeh = ").append(" $(\"#cusCodeid\").find(\"option:selected\").val();");
			sb.append("url += ").append("'&ids='+initValue+'&coscode='+coscodeh;"); 
		}
	...
	private void clearAll(StringBuffer sb,String methodname) {
		...
		if (isclear&&StringUtil.isNotEmpty(textname)) {
			...
			sb.append("$(\"input[name='" + hiddenName + "']\").val(\"\");");
			sb.append("}");
			}
	}
	/**
	...
	private void callback(StringBuffer sb,String methodname) {
		...
		if(StringUtil.isNotEmpty(hiddenName)){
			...
			sb.append("$(\"input[name='" + hiddenName + "']\").val(id);");
			sb.append("}");
		}
