...
public class BaCostServiceImpl extends CommonServiceImpl implements BaCostServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(BaCostEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(BaCostEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	...
	private void doDelBus(BaCostEntity t) throws Exception{
 	...
 	private Map<String,Object> populationMap(BaCostEntity t){
		...
		map.put("cost_type_code", t.getCostTypeCode());
		return map;
	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,BaCostEntity t){
 		...
 		sql  = sql.replace("#{cost_type_code}",String.valueOf(t.getCostTypeCode()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("ba_cost",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
